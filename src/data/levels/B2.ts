...
createRichWord('b2_diaper', 'Diaper', '/ˈdaɪəpə(r)/', 'дайэпэ', 'Подгузник (амер.)', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
  ...
  createRichWord('b2_dare', 'Dare', '/deər/', 'дэа', 'Сметь / Осмеливаться', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Иметь достаточно смелости, чтобы сделать что-то опасное или грубое; или вызов кому-то сделать это.',
    '- Возмущение: "How dare you!" (Как ты смеешь!)\n- Вызов: "Truth or dare" (Правда или действие)\n- Риск: "Don\'t you dare" (Не смей)',
    [
      { en: 'I didn\'t dare to tell him the bad news.', ru: 'Я не осмелился сообщить ему плохие новости.' },
      { en: 'How dare you speak to me like that!', ru: 'Как ты смеешь так со мной разговаривать!' },
      { en: 'He dared me to jump into the cold water.', ru: 'Он взял меня "на слабо" (вызвал) прыгнуть в холодную воду.' },
      { en: 'Don\'t you dare touch my phone.', ru: 'Не смей трогать мой телефон.' }
    ],
    []
  ),

  createRichWord('b2_dawn', 'Dawn', '/dɔːn/', 'дон', 'Рассвет / Заря', ProficiencyLevel.B2, 'noun', 'Low', 'Literary',
    'Время суток, когда появляется свет перед восходом солнца; начало чего-либо.',
    '- Время: "At dawn" (На рассвете)\n- Начало: "Dawn of a new era" (Заря новой эры)\n- Глагол: "It dawned on me" (Меня осенило)',
    [
      { en: 'We woke up at dawn to start our journey.', ru: 'Мы проснулись на рассвете, чтобы начать наше путешествие.' },
      { en: 'The birds start singing at dawn.', ru: 'Птицы начинают петь на рассвете.' },
      { en: 'It finally dawned on him that he was lost.', ru: 'До него наконец дошло (его осенило), что он заблудился.' },
      { en: 'They worked from dawn till dusk.', ru: 'Они работали от рассвета до заката.' }
    ],
    []
  ),

  createRichWord('b2_debt', 'Debt', '/det/', 'дэт', 'Долг', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Деньги, которые кто-то должен другому человеку или банку. Буква "b" не читается.',
    '- Финансы: "In debt" (В долгах)\n- Выплата: "Pay off a debt" (Выплатить долг)\n- Благодарность: "Debt of gratitude" (Долг благодарности)',
    [
      { en: 'He is heavily in debt to the bank.', ru: 'У него большие долги перед банком.' },
      { en: 'It took them years to pay off their debts.', ru: 'Им потребовались годы, чтобы выплатить свои долги.' },
      { en: 'I owe you a debt of gratitude for your help.', ru: 'Я в неоплатном долгу перед тобой за твою помощь.' },
      { en: 'Getting out of debt is their main priority.', ru: 'Выбраться из долгов — их главный приоритет.' }
    ],
    []
  ),

  createRichWord('b2_decent', 'Decent', '/ˈdiː.sənt/', 'дисент', 'Приличный / Достойный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Социально приемлемый; достаточно хороший по качеству; одетый (разг.).',
    '- Качество: "Decent job" (Достойная работа)\n- Люди: "Decent people" (Порядочные люди)\n- Одежда: "Are you decent?" (Ты одет?)',
    [
      { en: 'It is hard to find a decent job these days.', ru: 'В наши дни трудно найти достойную работу.' },
      { en: 'She earns a decent salary.', ru: 'Она получает приличную зарплату.' },
      { en: 'He seems like a decent guy.', ru: 'Он кажется порядочным парнем.' },
      { en: 'Don\'t come in, I\'m not decent!', ru: 'Не входи, я не одет!' }
    ],
    []
  ),

  createRichWord('b2_deck', 'Deck', '/dek/', 'дэк', 'Палуба / Колода', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Пол на корабле; деревянная платформа у дома; набор игральных карт.',
    '- Корабль: "On deck" (На палубе)\n- Игры: "Deck of cards" (Колода карт)\n- Транспорт: "Double-decker" (Двухэтажный автобус)',
    [
      { en: 'We stood on the deck and watched the sunset.', ru: 'Мы стояли на палубе и смотрели на закат.' },
      { en: 'Shuffle the deck of cards before dealing.', ru: 'Перетасуй колоду карт перед раздачей.' },
      { en: 'All hands on deck!', ru: 'Свистать всех наверх! (Все руки на палубу).' },
      { en: 'We built a wooden deck in our garden.', ru: 'Мы построили деревянный настил (террасу) в нашем саду.' }
    ],
    []
  ),

  createRichWord('b2_delight', 'Delight', '/dɪˈlaɪt/', 'дилайт', 'Восторг / Наслаждение', ProficiencyLevel.B2, 'noun', 'Low', 'Formal',
    'Чувство великого удовольствия или удовлетворения; или источник этого удовольствия.',
    '- Эмоция: "With delight" (С восторгом)\n- Источник: "A delight to watch" (Одно загляденье)\n- Глагол: "To delight" (Восхищать)',
    [
      { en: 'To my great delight, I won the competition.', ru: 'К моему великому восторгу, я выиграл соревнование.' },
      { en: 'The children squealed with delight.', ru: 'Дети визжали от восторга.' },
      { en: 'This garden is a delight in summer.', ru: 'Этот сад — просто наслаждение летом.' },
      { en: 'She takes delight in helping others.', ru: 'Она находит удовольствие в помощи другим.' }
    ],
    []
  ),

  createRichWord('b2_deny', 'Deny', '/dɪˈnaɪ/', 'динай', 'Отрицать / Отказывать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Сказать, что что-то неправда; или отказать кому-то в чем-то.',
    '- Правда: "Deny the charges" (Отрицать обвинения)\n- Доступ: "Access denied" (В доступе отказано)\n- Факт: "There is no denying" (Нельзя отрицать)',
    [
      { en: 'He denied stealing the money.', ru: 'Он отрицал, что украл деньги.' },
      { en: 'You cannot deny that she is talented.', ru: 'Ты не можешь отрицать, что она талантлива.' },
      { en: 'They were denied entry to the club.', ru: 'Им отказали во входе в клуб.' },
      { en: 'I never deny my children anything.', ru: 'Я никогда ни в чем не отказываю своим детям.' }
    ],
    []
  ),

  createRichWord('b2_depress', 'Depress', '/dɪˈpres/', 'дипрес', 'Угнетать / Вводить в депрессию', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Заставлять кого-то чувствовать себя очень грустным и лишенным надежды; снижать активность (экономика).',
    '- Чувства: "This weather depresses me" (Эта погода меня угнетает)\n- Экономика: "Depress prices" (Снижать цены)\n- Прил.: "Depressed" (Подавленный)',
    [
      { en: 'Wet weather always depresses me.', ru: 'Сырая погода всегда меня угнетает.' },
      { en: 'The news depressed everyone in the office.', ru: 'Новости повергли в уныние всех в офисе.' },
      { en: 'High interest rates can depress the economy.', ru: 'Высокие процентные ставки могут угнетать экономику.' },
      { en: 'Don\'t let failure depress you.', ru: 'Не позволяй неудаче ввергнуть тебя в депрессию.' }
    ],
    [
      { meaning: "Press down (button)", translation: "Нажимать", example: { en: "Depress the clutch pedal.", ru: "Выжмите педаль сцепления." } }
    ]
  ),

  createRichWord('b2_desire', 'Desire', '/dɪˈzaɪər/', 'дизайэ', 'Желание / Желать', ProficiencyLevel.B2, 'noun', 'Medium', 'Formal',
    'Сильное чувство хотения чего-либо (более формально, чем want/wish).',
    '- Чувство: "Strong desire" (Сильное желание)\n- Глагол: "Desire to learn" (Желать учиться)\n- Результат: "Desired effect" (Желаемый эффект)',
    [
      { en: 'She had a strong desire to return home.', ru: 'У нее было сильное желание вернуться домой.' },
      { en: 'We all desire happiness and health.', ru: 'Мы все желаем счастья и здоровья.' },
      { en: 'He has no desire to be famous.', ru: 'У него нет желания быть знаменитым.' },
      { en: 'The medicine did not have the desired effect.', ru: 'Лекарство не дало желаемого эффекта.' }
    ],
    []
  ),

  createRichWord('b2_desperate', 'Desperate', '/ˈdes.pər.ət/', 'дэспэрэт', 'Отчаянный / Безнадежный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Чувствующий безысходность и готовый на все; очень нуждающийся в чем-то; ситуация крайне плохая.',
    '- Состояние: "Desperate situation" (Отчаянная ситуация)\n- Нужда: "Desperate for money" (Остро нуждающийся в деньгах)\n- Попытка: "Desperate attempt" (Отчаянная попытка)',
    [
      { en: 'The doctors made a desperate attempt to save him.', ru: 'Врачи предприняли отчаянную попытку спасти его.' },
      { en: 'She was desperate to find a job.', ru: 'Она отчаянно пыталась найти работу.' },
      { en: 'They are living in desperate poverty.', ru: 'Они живут в безнадежной нищете.' },
      { en: 'He took desperate measures to solve the problem.', ru: 'Он принял отчаянные меры для решения проблемы.' }
    ],
    []
  ),

  createRichWord('b2_detect', 'Detect', '/dɪˈtekt/', 'дитект', 'Обнаруживать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Замечать или открывать что-то, что трудно увидеть или услышать; выявлять.',
    '- Прибор: "Metal detector" (Металлоискатель)\n- Изменение: "Detect a change" (Обнаружить изменение)\n- Преступление: "Detect crime" (Раскрывать преступление)',
    [
      { en: 'The sensor detects smoke and triggers the alarm.', ru: 'Датчик обнаруживает дым и включает сигнализацию.' },
      { en: 'I detected a note of sadness in her voice.', ru: 'Я уловил (обнаружил) нотку грусти в ее голосе.' },
      { en: 'The disease can be cured if detected early.', ru: 'Болезнь можно вылечить, если обнаружить ее на ранней стадии.' },
      { en: 'No viruses were detected on your computer.', ru: 'Вирусов на вашем компьютере не обнаружено.' }
    ],
    []
  ),

  createRichWord('b2_determine', 'Determine', '/dɪˈtɜː.mɪn/', 'дитёмин', 'Определять / Решать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Устанавливать факты точно; влиять на результат; принимать твердое решение.',
    '- Причина: "Determine the cause" (Установить причину)\n- Влияние: "Determine the future" (Определить будущее)\n- Характер: "Determined person" (Решительный человек)',
    [
      { en: 'Police are trying to determine the cause of the accident.', ru: 'Полиция пытается установить причину аварии.' },
      { en: 'Your exam results will determine your future.', ru: 'Твои результаты экзаменов определят твое будущее.' },
      { en: 'We are determined to finish the project on time.', ru: 'Мы полны решимости закончить проект вовремя.' },
      { en: 'Eye colour is determined by genetics.', ru: 'Цвет глаз определяется генетикой.' }
    ],
    []
  ),

  createRichWord('b2_dine', 'Dine', '/daɪn/', 'дайн', 'Обедать / Ужинать (офиц.)', ProficiencyLevel.B2, 'verb', 'Low', 'Formal',
    'Есть ужин, обычно в ресторане или в формальной обстановке.',
    '- Место: "Dine out" (Ужинать вне дома)\n- Событие: "Wine and dine" (Угощать / Поить и кормить)\n- Комната: "Dining room" (Столовая)',
    [
      { en: 'They dined at the most expensive restaurant in town.', ru: 'Они ужинали в самом дорогом ресторане города.' },
      { en: 'We rarely dine out these days.', ru: 'Мы редко ужинаем вне дома в последнее время.' },
      { en: 'The President dined with the Queen.', ru: 'Президент обедал с Королевой.' },
      { en: 'She loves to wine and dine her clients.', ru: 'Она любит угощать своих клиентов.' }
    ],
    []
  ),

  createRichWord('b2_directed', 'Directed', '/dɪˈrek.tɪd/', 'дайректид', 'Направленный / Управляемый', ProficiencyLevel.B2, 'adj', 'Low', 'Neutral',
    'Имеющий определенную цель или направление; управляемый кем-то (как фильм). Часто используется как причастие.',
    '- Цель: "Directed at" (Направленный на)\n- Кино: "Directed by" (Срежиссированный кем-то)\n- Обучение: "Self-directed" (Самостоятельный / Самоуправляемый)',
    [
      { en: 'The criticism was directed at the government.', ru: 'Критика была направлена в адрес правительства.' },
      { en: 'This is a film directed by Steven Spielberg.', ru: 'Это фильм, снятый Стивеном Спилбергом.' },
      { en: 'We encourage self-directed learning.', ru: 'Мы поощряем самостоятельное обучение.' },
      { en: 'The anger was directed towards me.', ru: 'Гнев был направлен на меня.' }
    ],
    []
  ),

  createRichWord('b2_discipline', 'Discipline', '/ˈdɪs.ə.plɪn/', 'дисиплин', 'Дисциплина', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Практика приучения людей подчиняться правилам; умение контролировать себя; область знаний.',
    '- Контроль: "Self-discipline" (Самодисциплина)\n- Порядок: "Keep discipline" (Поддерживать дисциплину)\n- Наказание: "Breach of discipline" (Нарушение дисциплины)',
    [
      { en: 'Soldiers need a high level of discipline.', ru: 'Солдатам необходим высокий уровень дисциплины.' },
      { en: 'It takes discipline to exercise every day.', ru: 'Требуется дисциплина, чтобы тренироваться каждый день.' },
      { en: 'The teacher struggled to maintain discipline in class.', ru: 'Учитель с трудом поддерживал дисциплину в классе.' },
      { en: 'Martial arts teach you mental discipline.', ru: 'Боевые искусства учат тебя ментальной дисциплине.' }
    ],
    [
      { meaning: "Field of study (academic)", translation: "Научная дисциплина", example: { en: "Various scientific disciplines.", ru: "Различные научные дисциплины." } }
    ]
  ),

  createRichWord('b2_disgust', 'Disgust', '/dɪsˈɡʌst/', 'дисгаст', 'Отвращение', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Сильное чувство неприязни или неодобрения, вызванное чем-то неприятным или аморальным.',
    '- Эмоция: "Look of disgust" (Взгляд, полный отвращения)\n- Реакция: "Turn away in disgust" (Отвернуться с отвращением)\n- Глагол: "It disgusts me" (Это вызывает у меня отвращение)',
    [
      { en: 'She looked at the dirty plate with disgust.', ru: 'Она посмотрела на грязную тарелку с отвращением.' },
      { en: 'His rude behaviour filled me with disgust.', ru: 'Его грубое поведение наполнило меня отвращением.' },
      { en: 'The smell of the food disgusted him.', ru: 'Запах еды вызвал у него отвращение.' },
      { en: 'He threw the letter away in disgust.', ru: 'Он выбросил письмо с отвращением.' }
    ],
    []
  ),

  createRichWord('b2_disturb', 'Disturb', '/dɪˈstɜːb/', 'дистёб', 'Беспокоить / Мешать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Прерывать чей-то сон, работу или покой; волновать или расстраивать кого-то.',
    '- Сон: "Do not disturb" (Не беспокоить)\n- Покой: "Disturb the peace" (Нарушать общественный порядок)\n- Эмоция: "Disturbed by news" (Обеспокоен новостями)',
    [
      { en: 'Sorry to disturb you, but I have a question.', ru: 'Извините, что беспокою вас, но у меня есть вопрос.' },
      { en: 'Please do not disturb him while he is working.', ru: 'Пожалуйста, не мешайте ему, пока он работает.' },
      { en: 'The loud music disturbed the neighbours.', ru: 'Громкая музыка мешала соседям.' },
      { en: 'I was deeply disturbed by the images on TV.', ru: 'Я был глубоко встревожен изображениями по телевизору.' }
    ],
    []
  ),

  createRichWord('b2_drag', 'Drag', '/dræɡ/', 'дрэг', 'Тащить', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Тянуть что-то тяжелое по земле; заставлять кого-то идти куда-то; перетаскивать (компьютер).',
    '- Движение: "Drag a box" (Тащить коробку)\n- Компьютер: "Drag and drop" (Перетащить и бросить)\n- Время: "Time dragged" (Время тянулось)',
    [
      { en: 'He dragged the heavy suitcase across the floor.', ru: 'Он протащил тяжелый чемодан по полу.' },
      { en: 'Don\'t drag your feet when you walk.', ru: 'Не волочи ноги, когда идешь.' },
      { en: 'I had to drag him to the dentist.', ru: 'Мне пришлось тащить его к стоматологу силой.' },
      { en: 'The meeting dragged on for hours.', ru: 'Встреча тянулась часами.' }
    ],
    [
      { meaning: "A bore/annoyance (slang)", translation: "Тягомотина / Занудство", example: { en: "Homework is such a drag.", ru: "Домашка — такая тягомотина." } },
      { meaning: "Women's clothing on men", translation: "Дрэг (женская одежда)", example: { en: "Drag queen.", ru: "Дрэг-квин." } }
    ]
  ),

  createRichWord('b2_due', 'Due', '/djuː/', 'дъю', 'Ожидаемый / Должный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Ожидаемый в определенное время; обязательный к оплате; обусловленный чем-то (due to).',
    '- Время: "Due date" (Срок исполнения / ПДР)\n- Причина: "Due to rain" (Из-за дождя)\n- Долг: "Payment is due" (Срок оплаты настал)',
    [
      { en: 'The train is due at five o\'clock.', ru: 'Поезд должен прибыть в пять часов.' },
      { en: 'The rent is due on the first of the month.', ru: 'Арендную плату нужно внести первого числа месяца.' },
      { en: 'His success was due to hard work.', ru: 'Его успех был обусловлен усердной работой.' },
      { en: 'Give him the respect that is due to him.', ru: 'Окажите ему уважение, которое ему причитается.' }
    ],
    []
  ),

  createRichWord('b2_dump', 'Dump', '/dʌmp/', 'дамп', 'Сбрасывать / Бросать (разг.)', ProficiencyLevel.B2, 'verb', 'Medium', 'Informal',
    'Выбрасывать мусор в кучу; расставаться с парнем/девушкой (разг.); избавляться от чего-то.',
    '- Мусор: "Rubbish dump" (Свалка - сущ.)\n- Отношения: "Dump boyfriend" (Бросить парня)\n- Действие: "Dump the bag" (Сбросить сумку)',
    [
      { en: 'People shouldn\'t dump rubbish in the forest.', ru: 'Люди не должны сбрасывать мусор в лесу.' },
      { en: 'She dumped him because he was cheating.', ru: 'Она бросила его, потому что он изменял.' },
      { en: 'He dumped his bag on the sofa and sat down.', ru: 'Он бросил свою сумку на диван и сел.' },
      { en: 'They are looking for a place to dump the waste.', ru: 'Они ищут место, чтобы сбросить отходы.' }
    ],
    [
      { meaning: "Unpleasant place (noun)", translation: "Дыра (о месте)", example: { en: "This hotel is a dump.", ru: "Этот отель — настоящая дыра." } }
    ]
  ),
  createRichWord('b2_ease', 'Ease', '/iːz/', 'из', 'Легкость / Непринужденность', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Отсутствие трудности или боли; состояние покоя.',
    '- Действие: "With ease" (С легкостью)\n- Состояние: "At ease" (Вольно / Расслабленно)\n- Глагол: "Ease the pain" (Облегчить боль)',
    [
      { en: 'She passed the exam with ease.', ru: 'Она сдала экзамен с легкостью.' },
      { en: 'The medicine helped to ease the pain.', ru: 'Лекарство помогло облегчить боль.' },
      { en: 'I felt at ease in his company.', ru: 'Я чувствовал себя непринужденно в его компании.' },
      { en: 'He retired to a life of ease.', ru: 'Он ушел на пенсию к беззаботной жизни.' }
    ],
    []
  ),

  createRichWord('b2_elder', 'Elder', '/ˈel.dər/', 'элдэ', 'Старший / Старейшина', ProficiencyLevel.B2, 'adj', 'Low', 'Formal',
    'Старший по возрасту (обычно в семье); или уважаемый член общины (сущ.).',
    '- Семья: "Elder brother" (Старший брат)\n- Уважение: "Respect your elders" (Уважать старших)\n- Растение: "Elder tree" (Бузина)',
    [
      { en: 'My elder sister lives in France.', ru: 'Моя старшая сестра живет во Франции.' },
      { en: 'You should listen to your elders.', ru: 'Тебе следует слушать старших.' },
      { en: 'He is an elder of the church.', ru: 'Он старейшина церкви.' },
      { en: 'She is the elder of the two twins.', ru: 'Она старшая из двух близнецов.' }
    ],
    []
  ),

  createRichWord('b2_empire', 'Empire', '/ˈem.paɪər/', 'эмпайэ', 'Империя', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Группа стран, управляемая одним правителем или правительством.',
    '- История: "Roman Empire" (Римская империя)\n- Бизнес: "Business empire" (Бизнес-империя)\n- Здание: "Empire State Building" (Эмпайр-стейт-билдинг)',
    [
      { en: 'The Roman Empire lasted for centuries.', ru: 'Римская империя просуществовала столетия.' },
      { en: 'He built a vast business empire.', ru: 'Он построил огромную бизнес-империю.' },
      { en: 'The empire expanded across the continent.', ru: 'Империя расширилась по всему континенту.' },
      { en: 'The fall of the empire was sudden.', ru: 'Падение империи было внезапным.' }
    ],
    []
  ),

  createRichWord('b2_engage', 'Engage', '/ɪnˈɡeɪdʒ/', 'ингейдж', 'Вовлекать / Заниматься', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Привлекать внимание; участвовать в чем-то; нанимать.',
    '- Внимание: "Engage interest" (Вызвать интерес)\n- Участие: "Engage in conversation" (Вовлечь в разговор)\n- Статус: "Engaged" (Помолвлен / Занят)',
    [
      { en: 'The book failed to engage my interest.', ru: 'Книга не смогла вызвать у меня интерес.' },
      { en: 'They are engaged to be married.', ru: 'Они помолвлены.' },
      { en: 'Only a few students engaged in the debate.', ru: 'Лишь немногие студенты участвовали в дебатах.' },
      { en: 'The phone line is engaged.', ru: 'Телефонная линия занята.' }
    ],
    []
  ),

  createRichWord('b2_entire', 'Entire', '/ɪnˈtaɪər/', 'интайэ', 'Весь / Целый', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Полный; без каких-либо исключений (синоним whole, но более формальный).',
    '- Время: "Entire life" (Вся жизнь)\n- Количество: "Entire cake" (Весь торт целиком)\n- Группа: "Entire world" (Весь мир)',
    [
      { en: 'He spent his entire life in this village.', ru: 'Он провел всю свою жизнь в этой деревне.' },
      { en: 'I read the entire book in one day.', ru: 'Я прочитал всю книгу за один день.' },
      { en: 'The entire staff agreed with the decision.', ru: 'Весь персонал согласился с решением.' },
      { en: 'The entire building was destroyed by fire.', ru: 'Все здание было уничтожено огнем.' }
    ],
    []
  ),

  createRichWord('b2_establish', 'Establish', '/ɪˈstæb.lɪʃ/', 'истэблиш', 'Устанавливать / Основывать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Начать организацию или систему; выяснить факты; добиться признания.',
    '- Бизнес: "Establish a company" (Основать компанию)\n- Связи: "Establish relations" (Установить отношения)\n- Факты: "Establish the truth" (Установить истину)',
    [
      { en: 'The university was established in 1920.', ru: 'Университет был основан в 1920 году.' },
      { en: 'Police are trying to establish the cause of the fire.', ru: 'Полиция пытается установить причину пожара.' },
      { en: 'He quickly established himself as a leader.', ru: 'Он быстро зарекомендовал себя как лидер.' },
      { en: 'We need to establish clear rules.', ru: 'Нам нужно установить четкие правила.' }
    ],
    []
  ),

  createRichWord('b2_estate', 'Estate', '/ɪˈsteɪt/', 'истейт', 'Поместье / Имущество', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Большой участок земли с домом; всё имущество человека после смерти; жилой комплекс (брит.).',
    '- Рынок: "Real estate" (Недвижимость)\n- Жилье: "Housing estate" (Жилой микрорайон)\n- Наследство: "Leave an estate" (Оставить наследство)',
    [
      { en: 'He works as a real estate agent.', ru: 'Он работает агентом по недвижимости.' },
      { en: 'She lives on a council estate in London.', ru: 'Она живет в муниципальном микрорайоне в Лондоне.' },
      { en: 'The duke owns a large country estate.', ru: 'Герцог владеет большим загородным поместьем.' },
      { en: 'His estate was divided among his children.', ru: 'Его имущество было поделено между его детьми.' }
    ],
    []
  ),

  createRichWord('b2_evidence', 'Evidence', '/ˈev.ɪ.dəns/', 'эвидэнс', 'Улика / Доказательство', ProficiencyLevel.B2, 'noun', 'High', 'Formal',
    'Факты или информация, подтверждающие, что что-то верно. (Обычно неисчисляемое).',
    '- Суд: "Give evidence" (Давать показания)\n- Наука: "Scientific evidence" (Научное доказательство)\n- Поиск: "Look for evidence" (Искать улики)',
    [
      { en: 'There is no evidence to support his claim.', ru: 'Нет никаких доказательств, подтверждающих его заявление.' },
      { en: 'The police are looking for evidence of the crime.', ru: 'Полиция ищет улики преступления.' },
      { en: 'Scientists have found evidence of water on Mars.', ru: 'Ученые нашли доказательства наличия воды на Марсе.' },
      { en: 'Her smile was evidence of her happiness.', ru: 'Ее улыбка была свидетельством ее счастья.' }
    ],
    []
  ),

  createRichWord('b2_examine', 'Examine', '/ɪɡˈzæm.ɪn/', 'игзэмин', 'Осматривать / Исследовать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Смотреть на кого-то или что-то очень внимательно; проверять знания (экзаменовать).',
    '- Медицина: "Doctor examined the patient" (Врач осмотрел пациента)\n- Детали: "Examine closely" (Изучить внимательно)\n- Тест: "Examine students" (Экзаменовать студентов)',
    [
      { en: 'The doctor examined my broken leg.', ru: 'Врач осмотрел мою сломанную ногу.' },
      { en: 'We need to examine all the possibilities.', ru: 'Нам нужно рассмотреть (исследовать) все возможности.' },
      { en: 'The police examined the room for fingerprints.', ru: 'Полиция осмотрела комнату на наличие отпечатков пальцев.' },
      { en: 'Students are examined at the end of the year.', ru: 'Студентов экзаменуют в конце года.' }
    ],
    []
  ),

  createRichWord('b2_exhaust', 'Exhaust', '/ɪɡˈzɔːst/', 'игзост', 'Истомлять / Выхлоп', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Сильно утомлять (глагол); выхлопные газы или труба (сущ.).',
    '- Усталость: "Completely exhausted" (Полностью истощен)\n- Ресурсы: "Exhaust supplies" (Истощить запасы)\n- Авто: "Car exhaust" (Выхлопная труба)',
    [
      { en: 'The long journey exhausted the children.', ru: 'Долгая поездка истощила детей.' },
      { en: 'I am absolutely exhausted after work.', ru: 'Я абсолютно без сил (истощен) после работы.' },
      { en: 'Car exhaust fumes are bad for health.', ru: 'Выхлопные газы автомобилей вредны для здоровья.' },
      { en: 'We have exhausted all other options.', ru: 'Мы исчерпали все другие варианты.' }
    ],
    []
  ),

  createRichWord('b2_expense', 'Expense', '/ɪkˈspens/', 'икспенс', 'Расход / Трата', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Деньги, потраченные на что-то; стоимость чего-либо.',
    '- Деньги: "Travel expenses" (Командировочные расходы)\n- Цена: "At great expense" (Ценой больших затрат)\n- Счет: "At my expense" (За мой счет)',
    [
      { en: 'Buying a new car is a big expense.', ru: 'Покупка новой машины — это большие расходы.' },
      { en: 'The company paid for my travel expenses.', ru: 'Компания оплатила мои транспортные расходы.' },
      { en: 'He joked at my expense.', ru: 'Он пошутил за мой счет (надо мной).' },
      { en: 'We spared no expense for the wedding.', ru: 'Мы не жалели средств на свадьбу.' }
    ],
    []
  ),

  createRichWord('b2_expose', 'Expose', '/ɪkˈspəʊz/', 'икспоуз', 'Подвергать / Разоблачать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Убирать защиту или покрытие; открывать правду о чем-то плохом; подвергать влиянию.',
    '- Опасность: "Expose to danger" (Подвергать опасности)\n- Солнце: "Exposed to the sun" (Подверженный солнцу)\n- Правда: "Expose a lie" (Разоблачить ложь)',
    [
      { en: 'Do not expose your skin to the sun for too long.', ru: 'Не подвергайте кожу воздействию солнца слишком долго.' },
      { en: 'The journalist exposed the politician\'s corruption.', ru: 'Журналист разоблачил коррупцию политика.' },
      { en: 'The soldiers were exposed to enemy fire.', ru: 'Солдаты были открыты для вражеского огня.' },
      { en: 'He smiled, exposing his white teeth.', ru: 'Он улыбнулся, обнажив свои белые зубы.' }
    ],
    []
  ),

  createRichWord('b2_extend', 'Extend', '/ɪkˈstend/', 'икстенд', 'Продлевать / Расширять', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Сделать длиннее или больше; предложить (приглашение/помощь).',
    '- Время: "Extend the deadline" (Продлить дедлайн)\n- Размер: "Extend the house" (Расширить дом)\n- Рука: "Extend a hand" (Протянуть руку)',
    [
      { en: 'We decided to extend our holiday by a week.', ru: 'Мы решили продлить наш отпуск на неделю.' },
      { en: 'The forest extends for miles.', ru: 'Лес простирается на мили.' },
      { en: 'I would like to extend a warm welcome to you.', ru: 'Я хотел бы выразить вам теплый прием.' },
      { en: 'Can you extend your arm fully?', ru: 'Ты можешь полностью выпрямить руку?' }
    ],
    []
  ),

  createRichWord('b2_faint', 'Faint', '/feɪnt/', 'фейнт', 'Слабый / Падать в обморок', ProficiencyLevel.B2, 'adj', 'Low', 'Neutral',
    'Неясный, едва заметный (прил.); потерять сознание (глагол).',
    '- Звук: "Faint noise" (Слабый шум)\n- Здоровье: "Feel faint" (Чувствовать слабость/головокружение)\n- Глагол: "She fainted" (Она упала в обморок)',
    [
      { en: 'I heard a faint sound in the distance.', ru: 'Я услышал слабый звук вдалеке.' },
      { en: 'There is a faint smell of gas.', ru: 'Чувствуется слабый запах газа.' },
      { en: 'She fainted from hunger.', ru: 'Она упала в обморок от голода.' },
      { en: 'His writing is very faint and hard to read.', ru: 'Его почерк очень бледный и трудно читаемый.' }
    ],
    []
  ),

  createRichWord('b2_faith', 'Faith', '/feɪθ/', 'фейс', 'Вера', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Сильное доверие к кому-то или чему-то; религиозная вера.',
    '- Доверие: "Have faith in" (Верить в кого-то)\n- Религия: "Loss of faith" (Потеря веры)\n- Фраза: "In good faith" (Добросовестно)',
    [
      { en: 'I have complete faith in your ability.', ru: 'Я полностью верю в твои способности.' },
      { en: 'His faith in God helped him survive.', ru: 'Его вера в Бога помогла ему выжить.' },
      { en: 'You must not lose faith.', ru: 'Ты не должен терять веру.' },
      { en: 'She acted in good faith.', ru: 'Она действовала добросовестно.' }
    ],
    []
  ),

  createRichWord('b2_fascinate', 'Fascinate', '/ˈfæs.ən.eɪt/', 'фэсинейт', 'Очаровывать / Пленять', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Очень сильно интересовать кого-то.',
    '- Интерес: "Fascinate the audience" (Очаровать публику)\n- Прил.: "Fascinating story" (Увлекательная история)\n- Природа: "Fascinated by animals" (Очарован животными)',
    [
      { en: 'Science has always fascinated him.', ru: 'Наука всегда его увлекала.' },
      { en: 'I was fascinated by her voice.', ru: 'Я был очарован ее голосом.' },
      { en: 'The children were fascinated to see the tigers.', ru: 'Дети были зачарованы, увидев тигров.' },
      { en: 'Japan is a country that fascinates me.', ru: 'Япония — это страна, которая меня восхищает.' }
    ],
    []
  ),
  createRichWord('b2_debate', 'Debate', '/dɪˈbeɪt/', 'дибейт', 'Дебаты / Спор', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Формальное обсуждение, где высказываются разные аргументы; спор.',
    '- Политика: "Parliamentary debate" (Парламентские дебаты)\n- Интенсивность: "Heated debate" (Жаркий спор)\n- Глагол: "Debate the issue" (Обсуждать проблему)',
    [
      { en: 'There was a lively debate about the new law.', ru: 'Был оживленный спор по поводу нового закона.' },
      { en: 'Congress is debating the budget proposal.', ru: 'Конгресс обсуждает (дебатирует) бюджетное предложение.' },
      { en: 'The topic is open to debate.', ru: 'Эта тема открыта для обсуждения.' },
      { en: 'We debated whether to go or stay.', ru: 'Мы спорили (обдумывали), уйти или остаться.' }
    ],
    []
  ),

  createRichWord('b2_declare', 'Declare', '/dɪˈkleər/', 'диклэа', 'Объявлять / Заявлять', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Сказать что-то официально или публично; заявить о доходах/товарах на таможне.',
    '- Официально: "Declare war" (Объявить войну)\n- Таможня: "Nothing to declare" (Нечего декларировать)\n- Чувства: "Declare love" (Признаться в любви)',
    [
      { en: 'The government declared a state of emergency.', ru: 'Правительство объявило чрезвычайное положение.' },
      { en: 'Do you have anything to declare at customs?', ru: 'У вас есть что декларировать на таможне?' },
      { en: 'He declared that he was innocent.', ru: 'Он заявил, что невиновен.' },
      { en: 'The results were declared immediately.', ru: 'Результаты были объявлены немедленно.' }
    ],
    []
  ),

  createRichWord('b2_decline', 'Decline', '/dɪˈklaɪn/', 'диклайн', 'Снижаться / Отклонять', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Становиться меньше или хуже; вежливо отказаться от предложения.',
    '- Количество: "Sales declined" (Продажи снизились)\n- Отказ: "Decline an invitation" (Отклонить приглашение)\n- Сущ: "Steady decline" (Устойчивый спад)',
    [
      { en: 'The population of the village has declined.', ru: 'Население деревни сократилось.' },
      { en: 'I invited him, but he declined.', ru: 'Я пригласил его, но он вежливо отказался.' },
      { en: 'There is a sharp decline in profits this year.', ru: 'В этом году наблюдается резкий спад прибыли.' },
      { en: 'His health began to decline rapidly.', ru: 'Его здоровье начало стремительно ухудшаться.' }
    ],
    []
  ),

  createRichWord('b2_decrease', 'Decrease', '/dɪˈkriːs/', 'дикрис', 'Уменьшаться / Убывать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Становиться меньше в размере или количестве (противоположность increase).',
    '- Размер: "Decrease in size" (Уменьшиться в размере)\n- Количество: "Decrease the risk" (Снизить риск)\n- Сущ: "A slight decrease" (Небольшое снижение)',
    [
      { en: 'We need to decrease our spending.', ru: 'Нам нужно уменьшить наши расходы.' },
      { en: 'The number of visitors decreased in winter.', ru: 'Количество посетителей уменьшилось зимой.' },
      { en: 'Regular exercise decreases the risk of heart disease.', ru: 'Регулярные упражнения снижают риск сердечных заболеваний.' },
      { en: 'There was a decrease in temperature at night.', ru: 'Ночью произошло понижение температуры.' }
    ],
    []
  ),

  createRichWord('b2_dedicate', 'Dedicate', '/ˈded.ɪ.keɪt/', 'дэдикейт', 'Посвящать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Отдавать свое время и энергию чему-то; подписывать книгу/песню кому-то.',
    '- Время: "Dedicate life to..." (Посвятить жизнь...)\n- Искусство: "Dedicate a song" (Посвятить песню)\n- Прил: "Dedicated" (Преданный делу)',
    [
      { en: 'She dedicated her life to helping the poor.', ru: 'Она посвятила свою жизнь помощи бедным.' },
      { en: 'He dedicated his book to his wife.', ru: 'Он посвятил свою книгу жене.' },
      { en: 'This song is dedicated to my mother.', ru: 'Эта песня посвящается моей маме.' },
      { en: 'We need a dedicated team for this project.', ru: 'Нам нужна преданная делу команда для этого проекта.' }
    ],
    []
  ),

  createRichWord('b2_defeat', 'Defeat', '/dɪˈfiːt/', 'дифит', 'Побеждать / Наносить поражение', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Выиграть у кого-то в игре, войне или соревновании; провал (сущ.).',
    '- Спорт: "Defeat the champion" (Победить чемпиона)\n- Война: "Defeat the enemy" (Разгромить врага)\n- Сущ: "Admit defeat" (Признать поражение)',
    [
      { en: 'Our team defeated the visitors 3-0.', ru: 'Наша команда победила гостей со счетом 3:0.' },
      { en: 'Napoleon was defeated at Waterloo.', ru: 'Наполеон потерпел поражение при Ватерлоо.' },
      { en: 'We must not let this defeat stop us.', ru: 'Мы не должны позволить этому поражению остановить нас.' },
      { en: 'The bill was defeated in parliament.', ru: 'Законопроект был отклонен (побежден) в парламенте.' }
    ],
    []
  ),

  createRichWord('b2_democracy', 'Democracy', '/dɪˈmɒk.rə.si/', 'димокрэси', 'Демократия', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Система управления, где люди выбирают своих представителей голосованием.',
    '- Политика: "Liberal democracy" (Либеральная демократия)\n- Ценности: "Fight for democracy" (Бороться за демократию)\n- Принцип: "Principles of democracy" (Принципы демократии)',
    [
      { en: 'Freedom of speech is essential in a democracy.', ru: 'Свобода слова необходима в демократии.' },
      { en: 'They are transitioning to a democracy.', ru: 'Они переходят к демократии.' },
      { en: 'Voting is a key part of democracy.', ru: 'Голосование — ключевая часть демократии.' },
      { en: 'We must protect our democracy.', ru: 'Мы должны защищать нашу демократию.' }
    ],
    []
  ),

  createRichWord('b2_democrat', 'Democrat', '/ˈdem.ə.krat/', 'демокрэт', 'Демократ', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Сторонник демократии или член Демократической партии (особенно в США).',
    '- Политика: "Social democrat" (Социал-демократ)\n- США: "The Democrats" (Демократы)\n- Убеждения: "True democrat" (Истинный демократ)',
    [
      { en: 'He has always been a loyal Democrat.', ru: 'Он всегда был преданным демократом.' },
      { en: 'Democrats and Republicans often disagree.', ru: 'Демократы и республиканцы часто не соглашаются.' },
      { en: 'As a democrat, I believe in equal rights.', ru: 'Как демократ, я верю в равные права.' },
      { en: 'The democrats won the election.', ru: 'Демократы выиграли выборы.' }
    ],
    []
  ),

  createRichWord('b2_demonstrate', 'Demonstrate', '/ˈdem.ən.streɪt/', 'демонстрейт', 'Демонстрировать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Показывать, как что-то работает; доказывать что-то; участвовать в демонстрации/протесте.',
    '- Показ: "Demonstrate a product" (Демонстрировать продукт)\n- Доказательство: "Demonstrate clearly" (Ясно показать/доказать)\n- Протест: "Demonstrate against" (Митинговать против)',
    [
      { en: 'The teacher demonstrated how to use the equipment.', ru: 'Учитель продемонстрировал, как пользоваться оборудованием.' },
      { en: 'This study demonstrates the link between smoking and cancer.', ru: 'Это исследование доказывает (демонстрирует) связь между курением и раком.' },
      { en: 'Thousands of people demonstrated in the streets.', ru: 'Тысячи людей вышли на демонстрацию на улицы.' },
      { en: 'Can you demonstrate your skills to us?', ru: 'Вы можете продемонстрировать нам свои навыки?' }
    ],
    []
  ),

  createRichWord('b2_dense', 'Dense', '/dens/', 'денс', 'Плотный / Густой', ProficiencyLevel.B2, 'adj', 'Low', 'Neutral',
    'Содержащий много объектов в малом пространстве; труднопроходимый (о лесе/тумане).',
    '- Лес: "Dense forest" (Густой лес)\n- Население: "Dense population" (Плотное население)\n- Туман: "Dense fog" (Густой туман)',
    [
      { en: 'They got lost in the dense forest.', ru: 'Они заблудились в густом лесу.' },
      { en: 'The city has a very dense population.', ru: 'В городе очень плотное население.' },
      { en: 'Visibility was poor due to dense fog.', ru: 'Видимость была плохой из-за густого тумана.' },
      { en: 'This cake is very dense and heavy.', ru: 'Этот торт очень плотный и тяжелый.' }
    ],
    [
      { meaning: "Stupid (informal)", translation: "Тупой / Бестолковый", example: { en: "He's a bit dense sometimes.", ru: "Иногда он немного туповат." } }
    ]
  ),

  createRichWord('b2_deposit', 'Deposit', '/dɪˈpɒz.ɪt/', 'дипозит', 'Депозит / Залог', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Деньги, положенные в банк; или деньги, отданные как залог за аренду.',
    '- Банк: "Make a deposit" (Внести депозит/деньги)\n- Аренда: "Pay a deposit" (Внести залог)\n- Природа: "Mineral deposits" (Месторождения ископаемых)',
    [
      { en: 'I need to pay a deposit for the apartment.', ru: 'Мне нужно внести залог за квартиру.' },
      { en: 'She deposited a large sum of money in the bank.', ru: 'Она положила (внесла) большую сумму денег в банк.' },
      { en: 'We will return your deposit when you leave.', ru: 'Мы вернем ваш залог, когда вы съедете.' },
      { en: 'Fat deposits can block arteries.', ru: 'Жировые отложения могут блокировать артерии.' }
    ],
    []
  ),

  createRichWord('b2_descend', 'Descend', '/dɪˈsend/', 'дисенд', 'Спускаться', ProficiencyLevel.B2, 'verb', 'Low', 'Formal',
    'Двигаться вниз (по лестнице, склону и т.д.). Антоним: Ascend.',
    '- Движение: "Descend the stairs" (Спускаться по лестнице)\n- Самолет: "Plane descended" (Самолет снизился)\n- Тьма: "Darkness descended" (Тьма опустилась)',
    [
      { en: 'We descended the mountain slowly.', ru: 'Мы медленно спускались с горы.' },
      { en: 'The plane began to descend towards the airport.', ru: 'Самолет начал снижаться к аэропорту.' },
      { en: 'Silence descended on the room.', ru: 'Тишина опустилась на комнату.' },
      { en: 'The path descends steeply to the river.', ru: 'Тропа круто спускается к реке.' }
    ],
    []
  ),

  createRichWord('b2_destruction', 'Destruction', '/dɪˈstrʌk.ʃən/', 'дистракшн', 'Разрушение', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Действие по уничтожению чего-либо; состояние быть разрушенным.',
    '- Война: "Mass destruction" (Массовое поражение/разрушение)\n- Природа: "Destruction of forests" (Уничтожение лесов)\n- Глагол: "Destroy" (Разрушать)',
    [
      { en: 'The storm caused widespread destruction.', ru: 'Шторм вызвал повсеместные разрушения.' },
      { en: 'We must stop the destruction of the rainforests.', ru: 'Мы должны остановить уничтожение тропических лесов.' },
      { en: 'Weapons of mass destruction are dangerous.', ru: 'Оружие массового поражения опасно.' },
      { en: 'The destruction of the old building took weeks.', ru: 'Разрушение (снос) старого здания заняло недели.' }
    ],
    []
  ),

  createRichWord('b2_device', 'Device', '/dɪˈvaɪs/', 'дивайс', 'Устройство / Прибор', ProficiencyLevel.B2, 'noun', 'High', 'Neutral',
    'Механизм или гаджет, созданный для определенной цели (часто электронный).',
    '- Электроника: "Electronic device" (Электронное устройство)\n- Взрывчатка: "Explosive device" (Взрывное устройство)\n- Литература: "Rhetorical device" (Риторический прием)',
    [
      { en: 'You can control the lights with this device.', ru: 'Ты можешь управлять светом с помощью этого устройства.' },
      { en: 'Smartphones are very useful devices.', ru: 'Смартфоны — очень полезные устройства.' },
      { en: 'Leave your electronic devices in your bag.', ru: 'Оставьте свои электронные устройства в сумке.' },
      { en: 'A safety device prevents accidents.', ru: 'Предохранительное устройство предотвращает несчастные случаи.' }
    ],
    []
  ),

  createRichWord('b2_devote', 'Devote', '/dɪˈvəʊt/', 'дивоут', 'Посвящать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Отдавать все время или энергию делу или человеку (синоним dedicate).',
    '- Время: "Devote time to" (Уделять время чему-то)\n- Жизнь: "Devote oneself" (Посвятить себя)\n- Прил: "Devoted" (Преданный)',
    [
      { en: 'She devotes all her free time to gardening.', ru: 'Она посвящает все свое свободное время садоводству.' },
      { en: 'He devoted his life to science.', ru: 'Он посвятил свою жизнь науке.' },
      { en: 'They devoted a lot of money to the project.', ru: 'Они выделили (посвятили) много денег на проект.' },
      { en: 'I want to devote more attention to my family.', ru: 'Я хочу уделять больше внимания своей семье.' }
    ],
    []
  ),

  createRichWord('b2_differ', 'Differ', '/ˈdɪf.ər/', 'дифэ', 'Отличаться', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Быть не таким, как что-то другое; иметь другое мнение.',
    '- Сравнение: "Differ from" (Отличаться от)\n- Мнение: "Opinions differ" (Мнения расходятся)\n- Степень: "Differ greatly" (Сильно отличаться)',
    [
      { en: 'French differs from English in many ways.', ru: 'Французский отличается от английского во многом.' },
      { en: 'Our views on politics differ completely.', ru: 'Наши взгляды на политику полностью расходятся.' },
      { en: 'People differ in their ability to learn.', ru: 'Люди различаются в своей способности учиться.' },
      { en: 'The two reports differ on the key facts.', ru: 'Два отчета расходятся в ключевых фактах.' }
    ],
    []
  ),

  createRichWord('b2_dimension', 'Dimension', '/ˌdaɪˈmen.ʃən/', 'дайменшн', 'Измерение / Аспект', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Параметры объекта (длина, ширина); или аспект ситуации.',
    '- Пространство: "Three dimensions" (Три измерения - 3D)\n- Ситуация: "New dimension" (Новый аспект/измерение)\n- Размер: "Exact dimensions" (Точные размеры)',
    [
      { en: 'We live in a world of three dimensions.', ru: 'Мы живем в трехмерном мире.' },
      { en: 'This problem has a political dimension.', ru: 'У этой проблемы есть политический аспект (измерение).' },
      { en: 'Please measure the dimensions of the room.', ru: 'Пожалуйста, измерьте размеры комнаты.' },
      { en: 'Music adds a new dimension to the film.', ru: 'Музыка добавляет фильму новое измерение.' }
    ],
    []
  ),

  createRichWord('b2_diplomat', 'Diplomat', '/ˈdɪp.lə.mæt/', 'дипломат', 'Дипломат', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Официальное лицо, представляющее свою страну за границей.',
    '- Карьера: "Foreign diplomat" (Иностранный дипломат)\n- Качество: "Skilled diplomat" (Опытный дипломат)\n- Работа: "Work as a diplomat" (Работать дипломатом)',
    [
      { en: 'The diplomat negotiated a peace treaty.', ru: 'Дипломат провел переговоры о мирном договоре.' },
      { en: 'He wants to become a diplomat and travel.', ru: 'Он хочет стать дипломатом и путешествовать.' },
      { en: 'Diplomats enjoy diplomatic immunity.', ru: 'Дипломаты пользуются дипломатической неприкосновенностью.' },
      { en: 'You need to be a bit of a diplomat to solve this.', ru: 'Нужно быть немного дипломатом, чтобы решить это.' }
    ],
    []
  ),

  createRichWord('b2_disabled', 'Disabled', '/dɪˈseɪ.bəld/', 'дисейблд', 'С ограниченными возможностями / Инвалид', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Имеющий физические или ментальные ограничения. (Предпочтительный термин в английском).',
    '- Люди: "Disabled people" (Люди с ограниченными возможностями)\n- Доступ: "Disabled access" (Доступ для инвалидов)\n- Парковка: "Disabled parking" (Парковка для инвалидов)',
    [
      { en: 'The museum has full access for disabled visitors.', ru: 'В музее есть полный доступ для посетителей с ограниченными возможностями.' },
      { en: 'He was born disabled.', ru: 'Он родился инвалидом.' },
      { en: 'She cares for her severely disabled mother.', ru: 'Она ухаживает за своей тяжело больной (инвалидом) матерью.' },
      { en: 'There are special seats for the disabled.', ru: 'Есть специальные места для инвалидов.' }
    ],
    [
      { meaning: "Deactivated (technology)", translation: "Отключенный", example: { en: "The alarm is disabled.", ru: "Сигнализация отключена." } }
    ]
  ),

  createRichWord('b2_disorder', 'Disorder', '/dɪˈsɔː.dər/', 'дисодэ', 'Расстройство / Беспорядок', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Медицинское нарушение (болезнь); или отсутствие порядка (хаос/бунт).',
    '- Медицина: "Mental disorder" (Психическое расстройство)\n- Питание: "Eating disorder" (Расстройство пищевого поведения)\n- Хаос: "Public disorder" (Нарушение общественного порядка)',
    [
      { en: 'He suffers from a rare blood disorder.', ru: 'Он страдает редким заболеванием крови.' },
      { en: 'The room was in a state of disorder.', ru: 'Комната была в состоянии беспорядка.' },
      { en: 'Police were called to quell the disorder.', ru: 'Полицию вызвали, чтобы подавить беспорядки.' },
      { en: 'She was treated for an eating disorder.', ru: 'Она лечилась от расстройства пищевого поведения.' }
    ],
    []
  ),

  createRichWord('b2_distinguish', 'Distinguish', '/dɪˈstɪŋ.ɡwɪʃ/', 'дистингвиш', 'Различать / Отличать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Видеть разницу между двумя вещами; делать кого-то особенным.',
    '- Разница: "Distinguish between" (Различать между)\n- Цвета: "Distinguish colours" (Различать цвета)\n- Успех: "Distinguish oneself" (Выделиться/Прославиться)',
    [
      { en: 'It is hard to distinguish the twins apart.', ru: 'Трудно различить близнецов.' },
      { en: 'Can you distinguish between right and wrong?', ru: 'Ты умеешь отличать правильное от неправильного?' },
      { en: 'He distinguished himself as a brave soldier.', ru: 'Он отличился как храбрый солдат.' },
      { en: 'The brand is distinguished by its high quality.', ru: 'Бренд отличается своим высоким качеством.' }
    ],
    []
  ),

  createRichWord('b2_distribute', 'Distribute', '/dɪˈstrɪb.juːt/', 'дистрибьют', 'Распределять / Раздавать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Раздавать что-то многим людям; доставлять товары в магазины.',
    '- Благотворительность: "Distribute food" (Раздавать еду)\n- Бизнес: "Distribute products" (Распространять товары)\n- Роль: "Distribute tasks" (Распределять задачи)',
    [
      { en: 'The organization distributes food to the poor.', ru: 'Организация раздает еду бедным.' },
      { en: 'We need to distribute the leaflets to everyone.', ru: 'Нам нужно раздать листовки всем.' },
      { en: 'The profits were distributed among the staff.', ru: 'Прибыль была распределена между сотрудниками.' },
      { en: 'New blankets were distributed to the refugees.', ru: 'Беженцам раздали новые одеяла.' }
    ],
    []
  ),

  createRichWord('b2_diverse', 'Diverse', '/daɪˈvɜːs/', 'дайвёс', 'Разнообразный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Включающий много разных типов; разный.',
    '- Общество: "Diverse culture" (Разнообразная культура)\n- Выбор: "Diverse range" (Широкий/разнообразный ассортимент)\n- Мнения: "Diverse views" (Разные взгляды)',
    [
      { en: 'New York is a culturally diverse city.', ru: 'Нью-Йорк — культурно разнообразный город.' },
      { en: 'We have a diverse range of products.', ru: 'У нас разнообразный ассортимент продуктов.' },
      { en: 'The students come from diverse backgrounds.', ru: 'Студенты происходят из разных слоев общества.' },
      { en: 'His interests are very diverse.', ru: 'Его интересы очень разнообразны.' }
    ],
    []
  ),

  createRichWord('b2_division', 'Division', '/dɪˈvɪʒ.ən/', 'дивижн', 'Разделение / Деление', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Процесс разделения на части; отдел в компании; математическое действие.',
    '- Математика: "Multiplication and division" (Умножение и деление)\n- Компания: "Sales division" (Отдел продаж)\n- Мнение: "Create division" (Создавать раскол)',
    [
      { en: 'The division of the cake was unfair.', ru: 'Разделение торта было несправедливым.' },
      { en: 'Division is the opposite of multiplication.', ru: 'Деление — это противоположность умножения.' },
      { en: 'He works in the European division of the company.', ru: 'Он работает в европейском подразделении компании.' },
      { en: 'There is a deep division in the political party.', ru: 'В политической партии существует глубокий раскол.' }
    ],
    []
  ),

  createRichWord('b2_dna', 'DNA', '/ˌdiː.enˈeɪ/', 'ди-эн-эй', 'ДНК', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Химическое вещество в клетках, несущее генетическую информацию (Deoxyribonucleic acid).',
    '- Тест: "DNA test" (ДНК тест)\n- Улики: "DNA evidence" (Улики ДНК)\n- Профиль: "DNA profile" (Профиль ДНК)',
    [
      { en: 'Police used DNA to identify the criminal.', ru: 'Полиция использовала ДНК, чтобы опознать преступника.' },
      { en: 'Every person has unique DNA.', ru: 'У каждого человека уникальная ДНК.' },
      { en: 'They took a DNA sample from the suspect.', ru: 'Они взяли образец ДНК у подозреваемого.' },
      { en: 'The structure of DNA was discovered in 1953.', ru: 'Структура ДНК была открыта в 1953 году.' }
    ],
    []
  ),
  createRichWord('b2_domestic', 'Domestic', '/dəˈmes.tɪk/', 'дэместик', 'Домашний / Внутренний', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Относящийся к дому, семье или своей стране (не иностранный).',
    '- Страна: "Domestic flight" (Внутренний рейс)\n- Дом: "Domestic animals" (Домашние животные)\n- Быт: "Domestic chores" (Домашние обязанности)',
    [
      { en: 'Domestic flights are usually cheaper than international ones.', ru: 'Внутренние рейсы обычно дешевле международных.' },
      { en: 'They had a violent domestic argument.', ru: 'У них была жестокая семейная ссора.' },
      { en: 'Domestic cats are popular pets.', ru: 'Домашние кошки — популярные питомцы.' },
      { en: 'The government focuses on domestic policy.', ru: 'Правительство сосредотачивается на внутренней политике.' },
    ],
    []
  ),

  createRichWord('b2_dominant', 'Dominant', '/ˈdɒm.ɪ.nənt/', 'доминэнт', 'Доминирующий / Господствующий', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Более важный, сильный или заметный, чем остальные.',
    '- Положение: "Dominant position" (Господствующее положение)\n- Гены: "Dominant gene" (Доминантный ген)\n- Личность: "Dominant personality" (Доминирующая личность)',
    [
      { en: 'The company has a dominant position in the market.', ru: 'Компания занимает доминирующее положение на рынке.' },
      { en: 'Red is the dominant colour in this painting.', ru: 'Красный — доминирующий цвет на этой картине.' },
      { en: 'He plays a dominant role in the team.', ru: 'Он играет доминирующую роль в команде.' },
      { en: 'Brown eyes are a dominant trait.', ru: 'Карие глаза — это доминантный признак.' },
    ],
    []
  ),

  createRichWord('b2_dominate', 'Dominate', '/ˈdɒm.ɪ.neɪt/', 'доминейт', 'Доминировать / Возвышаться', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Иметь контроль или власть над кем-то; быть самым важным; возвышаться над местностью.',
    '- Спорт: "Dominate the game" (Доминировать в игре)\n- Власть: "Dominate the world" (Господствовать над миром)\n- Местность: "Mountain dominates" (Гора возвышается)',
    [
      { en: 'Our team dominated the match from start to finish.', ru: 'Наша команда доминировала в матче от начала до конца.' },
      { en: 'He tends to dominate the conversation.', ru: 'Он имеет тенденцию доминировать в разговоре.' },
      { en: 'The cathedral dominates the city skyline.', ru: 'Собор возвышается над панорамой города.' },
      { en: 'Don\'t let fear dominate your life.', ru: 'Не позволяй страху управлять твоей жизнью.' },
    ],
    []
  ),

  createRichWord('b2_dose', 'Dose', '/dəʊs/', 'доус', 'Доза', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Измеренное количество лекарства, которое нужно принять за один раз.',
    '- Лекарство: "Daily dose" (Суточная доза)\n- Перебор: "Overdose" (Передозировка)\n- Радиация: "High dose" (Высокая доза)',
    [
      { en: 'Do not exceed the recommended dose.', ru: 'Не превышайте рекомендованную дозу.' },
      { en: 'He took a large dose of cough syrup.', ru: 'Он принял большую дозу сиропа от кашля.' },
      { en: 'The doctor reduced the dose of my medication.', ru: 'Врач уменьшил дозу моего лекарства.' },
      { en: 'A small dose of luck is always helpful.', ru: 'Небольшая доля (доза) удачи всегда полезна.' },
    ],
    []
  ),

  createRichWord('b2_draft', 'Draft', '/drɑːft/', 'драфт', 'Черновик / Проект', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Предварительная версия текста; призыв в армию; чек (банк).',
    '- Текст: "First draft" (Первый черновик)\n- Армия: "Military draft" (Призыв в армию)\n- Пиво: "Draft beer" (Разливное пиво)',
    [
      { en: 'I wrote a rough draft of my speech.', ru: 'Я написал черновой вариант своей речи.' },
      { en: 'The final version is much better than the draft.', ru: 'Окончательная версия намного лучше черновика.' },
      { en: 'He avoided the draft by moving abroad.', ru: 'Он избежал призыва в армию, переехав за границу.' },
      { en: 'Do you prefer bottled or draft beer?', ru: 'Вы предпочитаете бутылочное или разливное пиво?' },
    ],
    [
      { meaning: "Cold air current (UK: Draught)", translation: "Сквозняк", example: { en: "There is a cold draft in here.", ru: "Здесь холодный сквозняк." } }
    ]
  ),

  createRichWord('b2_drain', 'Drain', '/dreɪn/', 'дрейн', 'Осушать / Водосток', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Удалять жидкость (глагол); труба для стока воды (сущ.); истощать силы.',
    '- Вода: "Drain the water" (Слить воду)\n- Силы: "Drain energy" (Истощать энергию)\n- Сущ.: "Down the drain" (Коту под хвост)',
    [
      { en: 'Drain the pasta before serving it.', ru: 'Слейте воду с макарон перед подачей.' },
      { en: 'The swimming pool needs to be drained.', ru: 'Бассейн нужно осушить.' },
      { en: 'The long meeting drained all my energy.', ru: 'Длинная встреча выжала из меня всю энергию.' },
      { en: 'Don\'t pour oil down the drain.', ru: 'Не выливайте масло в водосток.' },
    ],
    []
  ),

  createRichWord('b2_eager', 'Eager', '/ˈiː.ɡər/', 'игэр', 'Жаждущий / Страстно желающий', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Очень сильно желающий чего-то; полный энтузиазма.',
    '- Желание: "Eager to learn" (Жаждущий учиться)\n- Ожидание: "Eagerly await" (С нетерпением ждать)\n- Взгляд: "Eager look" (Нетерпеливый взгляд)',
    [
      { en: 'She is eager to start her new job.', ru: 'Она горит желанием начать свою новую работу.' },
      { en: 'The children were eager for Christmas to arrive.', ru: 'Дети с нетерпением ждали наступления Рождества.' },
      { en: 'He is an eager student who always asks questions.', ru: 'Он усердный студент, который всегда задает вопросы.' },
      { en: 'They eagerly accepted the invitation.', ru: 'Они с охотой приняли приглашение.' },
    ],
    []
  ),

  createRichWord('b2_echo', 'Echo', '/ˈek.əʊ/', 'экоу', 'Эхо / Повторять', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Звук, отражающийся от поверхности; повторение чьих-то слов или идей.',
    '- Звук: "Loud echo" (Громкое эхо)\n- Место: "Echo in the cave" (Эхо в пещере)\n- Глагол: "Echo his words" (Вторить его словам)',
    [
      { en: 'Her voice created an echo in the empty hall.', ru: 'Ее голос создал эхо в пустом зале.' },
      { en: 'The mountains echoed with the sound of thunder.', ru: 'Горы отозвались эхом на звук грома.' },
      { en: 'His views simply echo his father\'s opinions.', ru: 'Его взгляды просто повторяют мнение его отца.' },
      { en: 'There is a strange echo on the phone line.', ru: 'На телефонной линии странное эхо.' },
    ],
    []
  ),

  createRichWord('b2_efficient', 'Efficient', '/ɪˈfɪʃ.ənt/', 'ифишэнт', 'Эффективный / Рациональный', ProficiencyLevel.B2, 'adj', 'High', 'Neutral',
    'Работающий быстро и хорошо, без траты времени или энергии (в отличие от effective - просто дающий результат).',
    '- Работа: "Efficient worker" (Исполнительный работник)\n- Система: "Efficient system" (Рациональная система)\n- Топливо: "Fuel-efficient" (Экономичный)',
    [
      { en: 'This new engine is very fuel-efficient.', ru: 'Этот новый двигатель очень экономичен (эффективно расходует топливо).' },
      { en: 'She is an efficient secretary who never forgets anything.', ru: 'Она исполнительный секретарь, который никогда ничего не забывает.' },
      { en: 'We need a more efficient way to process data.', ru: 'Нам нужен более рациональный способ обработки данных.' },
      { en: 'The service at this hotel is friendly and efficient.', ru: 'Обслуживание в этом отеле дружелюбное и оперативное.' },
    ],
    []
  ),

  createRichWord('b2_embrace', 'Embrace', '/ɪmˈbreɪs/', 'имбрейс', 'Обнимать / Принимать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Держать кого-то в руках в знак любви; или с радостью принимать идею/предложение.',
    '- Любовь: "Warm embrace" (Теплое объятие - сущ.)\n- Идея: "Embrace change" (Принять перемены)\n- Культура: "Embrace culture" (Принять культуру)',
    [
      { en: 'She embraced her son before he left.', ru: 'Она обняла сына перед его отъездом.' },
      { en: 'We must embrace new technologies to succeed.', ru: 'Мы должны принять новые технологии, чтобы преуспеть.' },
      { en: 'He embraced the opportunity to travel.', ru: 'Он воспользовался (с радостью принял) возможностью путешествовать.' },
      { en: 'They held each other in a warm embrace.', ru: 'Они держали друг друга в теплых объятиях.' },
    ],
    []
  ),

  createRichWord('b2_emerge', 'Emerge', '/ɪˈmɜːdʒ/', 'имёрдж', 'Появляться / Возникать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Выходить из укрытия; становиться известным (о фактах).',
    '- Вид: "Emerge from the water" (Вынырнуть из воды)\n- Факты: "Truth emerged" (Правда всплыла)\n- Кризис: "Emerge from crisis" (Выйти из кризиса)',
    [
      { en: 'The sun emerged from behind the clouds.', ru: 'Солнце показалось из-за облаков.' },
      { en: 'New evidence emerged during the investigation.', ru: 'Новые улики всплыли в ходе расследования.' },
      { en: 'She emerged as the clear winner of the debate.', ru: 'Она вышла явным победителем дебатов.' },
      { en: 'A figure emerged from the shadows.', ru: 'Из тени появилась фигура.' },
    ],
    []
  ),

  createRichWord('b2_emphasis', 'Emphasis', '/ˈem.fə.sɪs/', 'эмфэсис', 'Акцент / Ударение', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Особая важность, придаваемая чему-то.',
    '- Важность: "Put emphasis on" (Делать акцент на)\n- Речь: "Change emphasis" (Сменить акцент)\n- Внимание: "Shift of emphasis" (Смещение акцента)',
    [
      { en: 'The school puts a lot of emphasis on sports.', ru: 'Школа делает большой акцент на спорте.' },
      { en: 'There was a shift of emphasis in his speech.', ru: 'В его речи произошло смещение акцентов.' },
      { en: 'You should place more emphasis on quality.', ru: 'Тебе следует уделять больше внимания качеству.' },
      { en: 'The emphasis is on practical skills.', ru: 'Упор делается на практические навыки.' },
    ],
    []
  ),

  createRichWord('b2_emphasise', 'Emphasise', '/ˈem.fə.saɪz/', 'эмфэсайз', 'Подчеркивать / Акцентировать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Показывать, что что-то очень важно (US: Emphasize).',
    '- Речь: "Emphasise the point" (Подчеркнуть мысль)\n- Важность: "Emphasise importance" (Подчеркнуть важность)\n- Слово: "Emphasise a word" (Выделить слово голосом)',
    [
      { en: 'I must emphasise that this rule is strict.', ru: 'Я должен подчеркнуть, что это правило строгое.' },
      { en: 'The report emphasises the need for change.', ru: 'Отчет подчеркивает необходимость перемен.' },
      { en: 'He emphasised the importance of honesty.', ru: 'Он акцентировал внимание на важности честности.' },
      { en: 'She spoke loudly to emphasise her anger.', ru: 'Она говорила громко, чтобы подчеркнуть свой гнев.' },
    ],
    []
  ),

  createRichWord('b2_enable', 'Enable', '/ɪˈneɪ.bəl/', 'инейбл', 'Давать возможность / Включать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Делать возможным для кого-то что-то сделать; активировать функцию.',
    '- Возможность: "Enable me to go" (Позволить мне пойти)\n- Техника: "Enable cookies" (Включить куки)\n- Рост: "Enable growth" (Способствовать росту)',
    [
      { en: 'The scholarship enabled him to study abroad.', ru: 'Стипендия дала ему возможность учиться за границей.' },
      { en: 'Technology enables us to work from home.', ru: 'Технологии позволяют нам работать из дома.' },
      { en: 'Please enable JavaScript in your browser.', ru: 'Пожалуйста, включите JavaScript в вашем браузере.' },
      { en: 'This tool will enable you to work faster.', ru: 'Этот инструмент позволит вам работать быстрее.' },
    ],
    []
  ),

  createRichWord('b2_encounter', 'Encounter', '/ɪnˈkaʊn.tər/', 'инкаутэ', 'Сталкиваться / Встреча', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Неожиданно встретить кого-то или столкнуться с трудностью; случайная встреча (сущ.).',
    '- Проблема: "Encounter difficulties" (Столкнуться с трудностями)\n- Люди: "Brief encounter" (Короткая встреча)\n- Опасность: "Encounter danger" (Встретить опасность)',
    [
      { en: 'We encountered some problems with the computer.', ru: 'Мы столкнулись с некоторыми проблемами с компьютером.' },
      { en: 'I first encountered him in Paris.', ru: 'Впервые я встретил его в Париже.' },
      { en: 'Their encounter was brief but memorable.', ru: 'Их встреча была короткой, но запоминающейся.' },
      { en: 'Did you encounter any wild animals?', ru: 'Вы встречали каких-нибудь диких животных?' },
    ],
    []
  ),

  createRichWord('b2_endure', 'Endure', '/ɪnˈdʒʊər/', 'инджуэ', 'Выносить / Терпеть', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Страдать от чего-то болезненного или трудного в течение долгого времени; продолжаться.',
    '- Боль: "Endure pain" (Терпеть боль)\n- Испытание: "Endure hardship" (Выносить лишения)\n- Время: "Endure forever" (Длиться вечно)',
    [
      { en: 'She had to endure a lot of pain during the treatment.', ru: 'Ей пришлось вынести много боли во время лечения.' },
      { en: 'I cannot endure his rudeness any longer.', ru: 'Я больше не могу терпеть его грубость.' },
      { en: 'Their friendship endured for many years.', ru: 'Их дружба длилась много лет.' },
      { en: 'He endured the cold without complaining.', ru: 'Он терпел холод, не жалуясь.' },
    ],
    []
  ),

  createRichWord('b2_enhance', 'Enhance', '/ɪnˈhɑːns/', 'инханс', 'Улучшать / Усиливать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Увеличивать качество, ценность или статус чего-либо.',
    '- Качество: "Enhance quality" (Улучшить качество)\n- Внешность: "Enhance beauty" (Подчеркнуть красоту)\n- Опыт: "Enhance experience" (Улучшить опыт)',
    [
      { en: 'Good lighting can enhance the atmosphere of a room.', ru: 'Хорошее освещение может улучшить атмосферу комнаты.' },
      { en: 'He reads a lot to enhance his vocabulary.', ru: 'Он много читает, чтобы обогатить свой словарный запас.' },
      { en: 'This software enhances the quality of photos.', ru: 'Эта программа улучшает качество фотографий.' },
      { en: 'The sauce enhances the flavour of the meat.', ru: 'Соус усиливает вкус мяса.' },
    ],
    []
  ),

  createRichWord('b2_ensure', 'Ensure', '/ɪnˈʃɔːr/', 'иншо:', 'Обеспечивать / Гарантировать', ProficiencyLevel.B2, 'verb', 'High', 'Formal',
    'Сделать так, чтобы что-то обязательно произошло.',
    '- Безопасность: "Ensure safety" (Обеспечить безопасность)\n- Результат: "Ensure success" (Гарантировать успех)\n- Действие: "Please ensure that" (Пожалуйста, убедитесь, что)',
    [
      { en: 'Please ensure that the door is locked.', ru: 'Пожалуйста, убедитесь, что дверь заперта.' },
      { en: 'We must ensure equal rights for everyone.', ru: 'Мы должны обеспечить равные права для всех.' },
      { en: 'This measure will ensure the safety of passengers.', ru: 'Эта мера обеспечит безопасность пассажиров.' },
      { en: 'Make sure to ensure your car against theft.', ru: 'Обязательно застрахуйте свою машину от угона (обычно insure, но здесь ensure как гарантия).' },
    ],
    [
      { meaning: "Insure (confusion)", translation: "Страховать (путаница)", example: { en: "Ensure implies guarantee, Insure implies money.", ru: "Ensure — гарантировать, Insure — страховать (финансово)." } }
    ]
  ),

  createRichWord('b2_enterprise', 'Enterprise', '/ˈen.tə.praɪz/', 'энтэпрайз', 'Предприятие / Предприимчивость', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Компания или бизнес; или готовность делать новые и сложные вещи.',
    '- Бизнес: "Small enterprise" (Малое предприятие)\n- Качество: "Spirit of enterprise" (Дух предпринимательства)\n- Проект: "Criminal enterprise" (Преступная деятельность)',
    [
      { en: 'He works for a state-owned enterprise.', ru: 'Он работает на государственном предприятии.' },
      { en: 'Starting a new business requires enterprise.', ru: 'Запуск нового бизнеса требует предприимчивости.' },
      { en: 'This is a joint enterprise between two companies.', ru: 'Это совместное предприятие двух компаний.' },
      { en: 'She showed great enterprise in solving the problem.', ru: 'Она проявила большую предприимчивость в решении проблемы.' },
    ],
    []
  ),

  createRichWord('b2_enthusiasm', 'Enthusiasm', '/ɪnˈθjuː.zi.æz.əm/', 'инсьюзиэзэм', 'Энтузиазм / Воодушевление', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Сильное чувство интереса и удовольствия от чего-либо.',
    '- Чувство: "Full of enthusiasm" (Полный энтузиазма)\n- Потеря: "Lose enthusiasm" (Потерять энтузиазм)\n- Проявление: "Show enthusiasm" (Проявлять энтузиазм)',
    [
      { en: 'She talked about her new hobby with great enthusiasm.', ru: 'Она говорила о своем новом хобби с большим энтузиазмом.' },
      { en: 'His enthusiasm for the project inspired us.', ru: 'Его энтузиазм по поводу проекта вдохновил нас.' },
      { en: 'I don\'t share your enthusiasm for football.', ru: 'Я не разделяю твоего восторга по поводу футбола.' },
      { en: 'Their initial enthusiasm soon faded.', ru: 'Их первоначальный энтузиазм вскоре угас.' },
    ],
    []
  ),

  createRichWord('b2_enthusiastic', 'Enthusiastic', '/ɪnˌθjuː.ziˈæs.tɪk/', 'инсьюзиэстик', 'Восторженный / Увлеченный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Показывающий большой интерес и радость.',
    '- Человек: "Enthusiastic supporter" (Ярый сторонник)\n- Реакция: "Enthusiastic welcome" (Восторженный прием)\n- Отношение: "Not very enthusiastic" (Не особо в восторге)',
    [
      { en: 'The audience was very enthusiastic about the play.', ru: 'Публика была в восторге от пьесы.' },
      { en: 'He is an enthusiastic reader of science fiction.', ru: 'Он увлеченный читатель научной фантастики.' },
      { en: 'She did not seem enthusiastic about the idea.', ru: 'Она не казалась воодушевленной этой идеей.' },
      { en: 'They gave him an enthusiastic round of applause.', ru: 'Они наградили его восторженными аплодисментами.' },
    ],
    []
  ),

  createRichWord('b2_equation', 'Equation', '/ɪˈkweɪ.ʒən/', 'иквейжн', 'Уравнение', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Математическое выражение, показывающее равенство двух величин; сложная ситуация со многими факторами.',
    '- Математика: "Solve an equation" (Решить уравнение)\n- Ситуация: "Part of the equation" (Часть уравнения/проблемы)\n- Сложность: "Complex equation" (Сложное уравнение)',
    [
      { en: 'Can you solve this quadratic equation?', ru: 'Ты можешь решить это квадратное уравнение?' },
      { en: 'Money is a big part of the equation.', ru: 'Деньги — это большая часть этого уравнения (ситуации).' },
      { en: 'The equation contains two unknown variables.', ru: 'Уравнение содержит две неизвестные переменные.' },
      { en: 'Managing staff is a difficult equation to balance.', ru: 'Управление персоналом — это сложное уравнение для балансировки.' },
    ],
    []
  ),

  createRichWord('b2_equivalent', 'Equivalent', '/ɪˈkwɪv.əl.ənt/', 'иквивэлэнт', 'Эквивалент / Равноценный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Имеющий ту же ценность, значение или функцию.',
    '- Ценность: "Roughly equivalent" (Примерно равноценный)\n- Деньги: "Equivalent amount" (Эквивалентная сумма)\n- Сущ.: "The equivalent of" (Эквивалент чего-либо)',
    [
      { en: 'Ten dollars is roughly equivalent to nine euros.', ru: 'Десять долларов примерно эквивалентны девяти евро.' },
      { en: 'There is no direct equivalent for this word in English.', ru: 'В английском языке нет прямого эквивалента этому слову.' },
      { en: 'His silence was equivalent to an admission of guilt.', ru: 'Его молчание было равносильно признанию вины.' },
      { en: 'Is there an equivalent product on the market?', ru: 'Есть ли на рынке аналогичный (эквивалентный) продукт?' },
    ],
    []
  ),

  createRichWord('b2_era', 'Era', '/ˈɪə.rə/', 'ирэ', 'Эра / Эпоха', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Длительный период истории с особыми характеристиками.',
    '- История: "Victorian era" (Викторианская эпоха)\n- Современность: "Digital era" (Цифровая эра)\n- Конец: "End of an era" (Конец эпохи)',
    [
      { en: 'We are living in a new era of technology.', ru: 'Мы живем в новую эру технологий.' },
      { en: 'The steam engine marked the beginning of a new era.', ru: 'Паровой двигатель ознаменовал начало новой эры.' },
      { en: 'His retirement marks the end of an era.', ru: 'Его выход на пенсию знаменует конец эпохи.' },
      { en: 'The Soviet era ended in the early nineties.', ru: 'Советская эпоха закончилась в начале девяностых.' },
    ],
    []
  ),

  createRichWord('b2_ethnic', 'Ethnic', '/ˈeθ.nɪk/', 'эсник', 'Этнический', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Относящийся к расе или народу с общей культурой.',
    '- Люди: "Ethnic minority" (Этническое меньшинство)\n- Конфликт: "Ethnic violence" (Межэтническое насилие)\n- Стиль: "Ethnic food" (Национальная кухня)',
    [
      { en: 'The city is home to many ethnic groups.', ru: 'Город является домом для многих этнических групп.' },
      { en: 'I enjoy trying ethnic food from different countries.', ru: 'Мне нравится пробовать национальную кухню разных стран.' },
      { en: 'Ethnic diversity makes our society richer.', ru: 'Этническое разнообразие делает наше общество богаче.' },
      { en: 'We must respect ethnic differences.', ru: 'Мы должны уважать этнические различия.' },
    ],
    []
  ),

  createRichWord('b2_evaluate', 'Evaluate', '/ɪˈvæl.ju.eɪt/', 'ивэльюэйт', 'Оценивать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Судить или подсчитывать качество, важность или ценность чего-либо (анализировать).',
    '- Работа: "Evaluate performance" (Оценивать производительность)\n- Ситуация: "Evaluate the situation" (Оценить ситуацию)\n- Результат: "Evaluate results" (Оценить результаты)',
    [
      { en: 'It is too early to evaluate the success of the project.', ru: 'Слишком рано оценивать успех проекта.' },
      { en: 'Doctors evaluated the patient\'s condition.', ru: 'Врачи оценили состояние пациента.' },
      { en: 'We need to evaluate the risks involved.', ru: 'Нам нужно оценить сопряженные риски.' },
      { en: 'The teacher evaluated our essays carefully.', ru: 'Учитель внимательно оценил наши эссе.' },
    ],
    []
  ),

  createRichWord('b2_evident', 'Evident', '/ˈev.ɪ.dənt/', 'эвидэнт', 'Очевидный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Легко видимый или понятный; ясный.',
    '- Факт: "It is evident that" (Очевидно, что)\n- Признак: "Self-evident" (Самоочевидный)\n- Чувства: "Evident relief" (Очевидное облегчение)',
    [
      { en: 'It was evident that she was unhappy.', ru: 'Было очевидно, что она несчастна.' },
      { en: 'His guilt was evident to everyone in the room.', ru: 'Его вина была очевидна всем в комнате.' },
      { en: 'With evident pride, he showed us his trophy.', ru: 'С явной гордостью он показал нам свой трофей.' },
      { en: 'The solution to the problem is not immediately evident.', ru: 'Решение проблемы не является сразу очевидным.' },
    ],
    []
  ),

  createRichWord('b2_evolution', 'Evolution', '/ˌiː.vəˈluː.ʃən/', 'ивэлюшн', 'Эволюция / Развитие', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Процесс постепенного развития живых существ или идей.',
    '- Биология: "Theory of evolution" (Теория эволюции)\n- Развитие: "Human evolution" (Эволюция человека)\n- Процесс: "Gradual evolution" (Постепенное развитие)',
    [
      { en: 'Darwin proposed the theory of evolution.', ru: 'Дарвин предложил теорию эволюции.' },
      { en: 'The evolution of the internet has been rapid.', ru: 'Развитие интернета было стремительным.' },
      { en: 'We are studying the evolution of language.', ru: 'Мы изучаем эволюцию языка.' },
      { en: 'Social evolution takes a long time.', ru: 'Социальная эволюция занимает много времени.' },
    ],
    []
  ),

  createRichWord('b2_evolve', 'Evolve', '/ɪˈvɒlv/', 'иволв', 'Развиваться / Эволюционировать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Постепенно меняться и развиваться в более сложную форму.',
    '- Биология: "Evolve from" (Эволюционировать из)\n- Бизнес: "Evolve into" (Развиться в)\n- Идея: "Plan evolved" (План развился)',
    [
      { en: 'Birds are believed to have evolved from dinosaurs.', ru: 'Считается, что птицы произошли (эволюционировали) от динозавров.' },
      { en: 'The company has evolved into a global giant.', ru: 'Компания превратилась (развилась) в мирового гиганта.' },
      { en: 'Our strategy needs to evolve with the market.', ru: 'Наша стратегия должна развиваться вместе с рынком.' },
      { en: 'Did humans evolve from apes?', ru: 'Произошли ли люди от обезьян?' },
    ],
    []
  ),

  createRichWord('b2_exclude', 'Exclude', '/ɪkˈskluːd/', 'иксклюд', 'Исключать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Не допускать кого-то куда-то; намеренно не включать что-то.',
    '- Группа: "Exclude from the team" (Исключить из команды)\n- Возможность: "Exclude possibility" (Исключить возможность)\n- Список: "Excluded items" (Исключенные пункты)',
    [
      { en: 'Women were excluded from the club until recently.', ru: 'Женщины были исключены из клуба до недавнего времени.' },
      { en: 'We cannot exclude the possibility of a mistake.', ru: 'Мы не можем исключать возможность ошибки.' },
      { en: 'The price excludes tax and service.', ru: 'Цена не включает (исключает) налог и обслуживание.' },
      { en: 'He felt excluded when his friends went out without him.', ru: 'Он чувствовал себя отверженным (исключенным), когда друзья пошли гулять без него.' },
    ],
    []
  ),

  createRichWord('b2_executive', 'Executive', '/ɪɡˈzek.jə.tɪv/', 'игзекьютив', 'Руководитель / Исполнительный', ProficiencyLevel.B2, 'noun', 'Medium', 'Formal',
    'Человек с высокой должностью в бизнесе, принимающий решения; относящийся к управлению.',
    '- Должность: "Chief Executive" (Генеральный директор)\n- Орган: "Executive committee" (Исполнительный комитет)\n- Бизнес: "Executive decision" (Волевое решение руководства)',
    [
      { en: 'She is a senior executive in a bank.', ru: 'Она старший руководитель в банке.' },
      { en: 'The executive board meets every month.', ru: 'Исполнительный совет собирается каждый месяц.' },
      { en: 'He made an executive decision to cancel the project.', ru: 'Он принял волевое (руководящее) решение отменить проект.' },
      { en: 'Executive cars are usually expensive and comfortable.', ru: 'Автомобили представительского класса обычно дорогие и комфортные.' },
    ],
    []
  ),

  createRichWord('b2_exhibit', 'Exhibit', '/ɪɡˈzɪb.ɪt/', 'игзибит', 'Экспонат / Выставлять', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Предмет на выставке (сущ.); показывать что-то публике или проявлять качество (гл.).',
    '- Музей: "Museum exhibit" (Музейный экспонат)\n- Глагол: "Exhibit symptoms" (Проявлять симптомы)\n- Искусство: "Exhibit paintings" (Выставлять картины)',
    [
      { en: 'Please do not touch the exhibits.', ru: 'Пожалуйста, не трогайте экспонаты.' },
      { en: 'The gallery is exhibiting works by young artists.', ru: 'Галерея выставляет работы молодых художников.' },
      { en: 'The patient exhibited signs of recovery.', ru: 'Пациент проявил признаки выздоровления.' },
      { en: 'This exhibit dates back to the Roman times.', ru: 'Этот экспонат датируется римскими временами.' },
    ],
    []
  ),
 createRichWord('b2_debut', 'Debut', '/ˈdeɪ.bjuː/', 'дэйбью', 'Дебют', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Первое публичное выступление или появление. Обратите внимание: "t" на конце не читается.',
    '- Карьера: "Make a debut" (Дебютировать)\n- Кино: "Debut album" (Дебютный альбом)\n- Спорт: "Professional debut" (Профессиональный дебют)',
    [
      { en: 'She made her acting debut at the age of eight.', ru: 'Она дебютировала как актриса в возрасте восьми лет.' },
      { en: 'The band\'s debut album was a huge success.', ru: 'Дебютный альбом группы имел огромный успех.' },
      { en: 'He scored a goal on his debut for the team.', ru: 'Он забил гол в своем дебютном матче за команду.' },
      { en: 'The new car will make its debut at the show.', ru: 'Новая машина дебютирует на выставке.' }
    ],
    []
  ),

  createRichWord('b2_decay', 'Decay', '/dɪˈkeɪ/', 'дикей', 'Гниение / Разрушение', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Процесс постепенного разрушения естественным путем (гниение зубов, зданий, органики).',
    '- Здоровье: "Tooth decay" (Кариес/разрушение зубов)\n- Город: "Urban decay" (Упадок города)\n- Глагол: "To decay" (Гнить)',
    [
      { en: 'Sugar is a major cause of tooth decay.', ru: 'Сахар — главная причина разрушения зубов.' },
      { en: 'The old house had fallen into decay.', ru: 'Старый дом пришел в упадок.' },
      { en: 'Leaves decay and nourish the soil.', ru: 'Листья гниют и удобряют почву.' },
      { en: 'The smell of decay was everywhere.', ru: 'Запах гниения был повсюду.' }
    ],
    []
  ),

  createRichWord('b2_decisive', 'Decisive', '/dɪˈsaɪ.sɪv/', 'дисайсив', 'Решающий / Решительный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Способный быстро принимать решения; или имеющий решающее значение для результата.',
    '- Личность: "Decisive leader" (Решительный лидер)\n- Событие: "Decisive battle" (Решающая битва)\n- Роль: "Play a decisive role" (Играть решающую роль)',
    [
      { en: 'You need to be decisive in a crisis.', ru: 'В кризис нужно быть решительным.' },
      { en: 'This goal proved to be decisive.', ru: 'Этот гол оказался решающим.' },
      { en: 'She gave a decisive answer.', ru: 'Она дала решительный ответ.' },
      { en: 'Lack of decisive action made things worse.', ru: 'Отсутствие решительных действий усугубило ситуацию.' }
    ],
    []
  ),

  createRichWord('b2_defect', 'Defect', '/ˈdiː.fekt/', 'дифект', 'Дефект / Брак', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Недостаток или неисправность в чем-либо. Глагол (defect /dɪˈfekt/) означает "дезертировать".',
    '- Товар: "Manufacturing defect" (Производственный брак)\n- Организм: "Birth defect" (Врожденный порок)\n- Характер: "Character defect" (Изъян характера)',
    [
      { en: 'The car was recalled due to a brake defect.', ru: 'Машину отозвали из-за дефекта тормозов.' },
      { en: 'He was born with a heart defect.', ru: 'Он родился с пороком сердца.' },
      { en: 'They inspect goods for any visual defects.', ru: 'Они проверяют товары на наличие визуальных дефектов.' },
      { en: 'It is a serious defect in the system.', ru: 'Это серьезный изъян в системе.' }
    ],
    [
      { meaning: "To leave a country/group (verb)", translation: "Дезертировать / Перебегать", example: { en: "He defected to the West.", ru: "Он перебежал на Запад." } }
    ]
  ),

  createRichWord('b2_delicate', 'Delicate', '/ˈdel.ɪ.kət/', 'дэликэт', 'Нежный / Хрупкий', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Легко ломающийся; требующий осторожного обращения; мягкий (о цвете/вкусе).',
    '- Предмет: "Delicate glass" (Хрупкое стекло)\n- Ситуация: "Delicate situation" (Щекотливая ситуация)\n- Внешность: "Delicate skin" (Нежная кожа)',
    [
      { en: 'Be careful with those delicate plates.', ru: 'Будь осторожен с этими хрупкими тарелками.' },
      { en: 'The negotiations are at a delicate stage.', ru: 'Переговоры находятся на деликатной стадии.' },
      { en: 'She has very delicate features.', ru: 'У нее очень тонкие (нежные) черты лица.' },
      { en: 'The flower has a delicate fragrance.', ru: 'У цветка нежный аромат.' }
    ],
    []
  ),

  createRichWord('b2_dependence', 'Dependence', '/dɪˈpen.dəns/', 'дипендэнс', 'Зависимость', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Ситуация, когда кто-то нуждается в чем-то или ком-то для поддержки или выживания.',
    '- Финансы: "Financial dependence" (Финансовая зависимость)\n- Вещества: "Drug dependence" (Наркотическая зависимость)\n- Энергия: "Oil dependence" (Нефтяная зависимость)',
    [
      { en: 'He wants to reduce his dependence on his parents.', ru: 'Он хочет уменьшить свою зависимость от родителей.' },
      { en: 'The country\'s dependence on imported oil is a problem.', ru: 'Зависимость страны от импортируемой нефти — это проблема.' },
      { en: 'Alcohol dependence can destroy lives.', ru: 'Алкогольная зависимость может разрушить жизни.' },
      { en: 'We need to declare independence, not dependence.', ru: 'Нам нужно провозгласить независимость, а не зависимость.' }
    ],
    []
  ),

  createRichWord('b2_despair', 'Despair', '/dɪˈspeər/', 'диспеэ', 'Отчаяние', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Чувство, что надежды больше нет.',
    '- Эмоция: "In despair" (В отчаянии)\n- Жест: "Hands in despair" (Руки в отчаянии)\n- Глагол: "Don\'t despair" (Не отчаивайся)',
    [
      { en: 'He gave up in despair.', ru: 'Он сдался в отчаянии.' },
      { en: 'Don\'t despair, we will find a solution.', ru: 'Не отчаивайся, мы найдем решение.' },
      { en: 'A look of despair crossed her face.', ru: 'Выражение отчаяния промелькнуло на ее лице.' },
      { en: 'She was driven to despair by the noise.', ru: 'Шум довел ее до отчаяния.' }
    ],
    []
  ),

  createRichWord('b2_despatch', 'Despatch', '/dɪˈspætʃ/', 'диспэтч', 'Отправлять / Посылать', ProficiencyLevel.B2, 'verb', 'Low', 'Formal',
    'Посылать кого-то или что-то в определенное место (вариант написания Dispatch).',
    '- Почта: "Despatch goods" (Отправлять товары)\n- Люди: "Despatch a messenger" (Послать гонца)\n- Сущ.: "With despatch" (Поспешно/Оперативно)',
    [
      { en: 'The goods were despatched yesterday.', ru: 'Товары были отправлены вчера.' },
      { en: 'An ambulance was despatched immediately.', ru: 'Скорая помощь была отправлена немедленно.' },
      { en: 'He dealt with the problem with despatch.', ru: 'Он разобрался с проблемой оперативно.' },
      { en: 'Please despatch this letter at once.', ru: 'Пожалуйста, отправьте это письмо немедленно.' }
    ],
    []
  ),

  createRichWord('b2_destiny', 'Destiny', '/ˈdes.tɪ.ni/', 'дэстини', 'Судьба / Предназначение', ProficiencyLevel.B2, 'noun', 'Low', 'Literary',
    'Сила, которая, как считается, контролирует то, что произойдет в будущем; ваша судьба.',
    '- Контроль: "Control your destiny" (Управлять своей судьбой)\n- Чувство: "Sense of destiny" (Чувство предназначения)\n- Неизбежность: "Manifest destiny" (Явное предначертание)',
    [
      { en: 'He believed it was his destiny to become king.', ru: 'Он верил, что стать королем было его судьбой.' },
      { en: 'You are the master of your own destiny.', ru: 'Ты хозяин своей судьбы.' },
      { en: 'Destiny brought us together.', ru: 'Судьба свела нас вместе.' },
      { en: 'We cannot escape our destiny.', ru: 'Мы не можем убежать от нашей судьбы.' }
    ],
    []
  ),

  createRichWord('b2_detach', 'Detach', '/dɪˈtætʃ/', 'дитэтч', 'Отсоединять / Отделять', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Снимать или отсоединять что-то.',
    '- Физически: "Detach the trailer" (Отцепить прицеп)\n- Документы: "Detach the coupon" (Оторвать купон)\n- Эмоции: "Detach yourself" (Абстрагироваться/Отстраниться)',
    [
      { en: 'You can detach the keyboard from the tablet.', ru: 'Вы можете отсоединить клавиатуру от планшета.' },
      { en: 'Please detach the lower part of the form.', ru: 'Пожалуйста, оторвите нижнюю часть бланка.' },
      { en: 'Try to detach yourself emotionally from the situation.', ru: 'Постарайся эмоционально отстраниться от ситуации.' },
      { en: 'The retina became detached.', ru: 'Сетчатка отслоилась.' }
    ],
    []
  ),

  createRichWord('b2_devil', 'Devil', '/ˈdev.əl/', 'дэвл', 'Дьявол', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Главный злой дух в религии; или злой/хитрый человек.',
    '- Идиома: "Speak of the devil" (Легок на помине)\n- Описание: "Little devil" (Чертенок - о ребенке)\n- Удача: "Lucky devil" (Счастливчик)',
    [
      { en: 'Speak of the devil, here he comes!', ru: 'Легок на помине, вот и он!' },
      { en: 'He sold his soul to the devil.', ru: 'Он продал душу дьяволу.' },
      { en: 'She works like a devil.', ru: 'Она работает как проклятая (как дьявол).' },
      { en: 'Better the devil you know.', ru: 'Лучше знакомое зло, чем незнакомое.' }
    ],
    []
  ),

  createRichWord('b2_dial', 'Dial', '/daɪəl/', 'дайэл', 'Набирать (номер) / Циферблат', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Вводить номер телефона (глагол); круглая панель на часах или приборе (сущ.).',
    '- Телефон: "Dial a number" (Набрать номер)\n- Прибор: "Speed dial" (Быстрый набор / Спидометр)\n- Радио: "Turn the dial" (Покрутить ручку настройки)',
    [
      { en: 'Dial 999 for emergency services.', ru: 'Наберите 999 для вызова экстренных служб.' },
      { en: 'The dial on the thermometer showed zero.', ru: 'Шкала на термометре показывала ноль.' },
      { en: 'I think I dialed the wrong number.', ru: 'Кажется, я набрал неверный номер.' },
      { en: 'Don\'t touch that dial!', ru: 'Не переключайтесь! (Не трогайте эту ручку).' }
    ],
    []
  ),

  createRichWord('b2_digest', 'Digest', '/daɪˈdʒest/', 'дайджест', 'Переваривать / Дайджест', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Перерабатывать пищу в желудке; осмысливать информацию (глагол). Сборник кратких новостей (сущ. /ˈdaɪ.dʒest/).',
    '- Еда: "Digest food" (Переваривать пищу)\n- Информация: "Digest the news" (Переварить новости)\n- Книга: "Reader\'s Digest" (Читательский дайджест)',
    [
      { en: 'It takes time to digest a heavy meal.', ru: 'Требуется время, чтобы переварить тяжелую пищу.' },
      { en: 'I need a moment to digest what you just said.', ru: 'Мне нужно время, чтобы переварить то, что ты сейчас сказал.' },
      { en: 'He reads a weekly news digest.', ru: 'Он читает еженедельный новостной дайджест.' },
      { en: 'Vegetables are easy to digest.', ru: 'Овощи легко перевариваются.' }
    ],
    []
  ),

  createRichWord('b2_dilemma', 'Dilemma', '/dɪˈlem.ə/', 'дилемма', 'Дилемма', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Ситуация, в которой нужно сделать трудный выбор между двумя вариантами.',
    '- Выбор: "Face a dilemma" (Столкнуться с дилеммой)\n- Решение: "Solve a dilemma" (Решить дилемму)\n- Тип: "Moral dilemma" (Моральная дилемма)',
    [
      { en: 'She faced a terrible dilemma.', ru: 'Она столкнулась с ужасной дилеммой.' },
      { en: 'The doctor was in a moral dilemma.', ru: 'Врач находился в моральной дилемме.' },
      { en: 'I am in a dilemma about what to wear.', ru: 'У меня дилемма, что надеть.' },
      { en: 'To tell the truth or not is a common dilemma.', ru: 'Сказать правду или нет — это частая дилемма.' }
    ],
    []
  ),

  createRichWord('b2_dim', 'Dim', '/dɪm/', 'дим', 'Тусклый / Приглушать', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Не яркий (о свете); не умный (разг.); делать свет тише (глагол).',
    '- Свет: "Dim light" (Тусклый свет)\n- Память: "Dim memory" (Смутное воспоминание)\n- Глагол: "Dim the lights" (Приглушить свет)',
    [
      { en: 'The light was too dim to read by.', ru: 'Свет был слишком тусклым для чтения.' },
      { en: 'He has a dim view of politicians.', ru: 'У него скептическое (мрачное) мнение о политиках.' },
      { en: 'Please dim the lights for the movie.', ru: 'Пожалуйста, приглуши свет для фильма.' },
      { en: 'My memories of that day are getting dim.', ru: 'Мои воспоминания о том дне становятся смутными.' }
    ],
    []
  ),

  createRichWord('b2_dioxide', 'Dioxide', '/daɪˈɒk.saɪd/', 'дайоксайд', 'Диоксид (Двуокись)', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Химическое соединение с двумя атомами кислорода.',
    '- Газ: "Carbon dioxide (CO2)" (Углекислый газ)\n- Экология: "Carbon dioxide emissions" (Выбросы углекислого газа)\n- Химия: "Sulphur dioxide" (Диоксид серы)',
    [
      { en: 'Plants absorb carbon dioxide.', ru: 'Растения поглощают углекислый газ.' },
      { en: 'Carbon dioxide is a greenhouse gas.', ru: 'Углекислый газ — это парниковый газ.' },
      { en: 'We need to reduce carbon dioxide levels.', ru: 'Нам нужно снизить уровень углекислого газа.' },
      { en: 'Yeast produces carbon dioxide.', ru: 'Дрожжи вырабатывают углекислый газ.' }
    ],
    []
  ),

  createRichWord('b2_dip', 'Dip', '/dɪp/', 'дип', 'Макать / Окунаться', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Быстро опустить что-то в жидкость и вынуть; кратковременное купание; густой соус.',
    '- Еда: "Dip chips" (Макать чипсы)\n- Вода: "Go for a dip" (Пойти искупаться)\n- График: "Profits dipped" (Прибыль немного упала)',
    [
      { en: 'She dipped her biscuit in the tea.', ru: 'Она макнула печенье в чай.' },
      { en: 'Let\'s go for a quick dip in the sea.', ru: 'Давай быстро искупаемся в море.' },
      { en: 'The temperature dipped below freezing.', ru: 'Температура опустилась ниже нуля.' },
      { en: 'Try this cheese dip with the vegetables.', ru: 'Попробуй этот сырный соус с овощами.' }
    ],
    []
  ),

  createRichWord('b2_discourage', 'Discourage', '/dɪˈskʌr.ɪdʒ/', 'дискаридж', 'Обескураживать / Отговаривать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Лишать уверенности; пытаться предотвратить что-то.',
    '- Мотивация: "Don\'t get discouraged" (Не падай духом)\n- Совет: "Discourage from smoking" (Отговаривать от курения)\n- Действие: "Discourage crime" (Препятствовать преступности)',
    [
      { en: 'Don\'t let one failure discourage you.', ru: 'Не позволяй одной неудаче обескуражить тебя.' },
      { en: 'My parents discouraged me from becoming an actor.', ru: 'Мои родители отговаривали меня становиться актером.' },
      { en: 'High prices discourage customers.', ru: 'Высокие цены отпугивают покупателей.' },
      { en: 'We want to discourage bad behaviour.', ru: 'Мы хотим предотвратить плохое поведение.' }
    ],
    []
  ),

  createRichWord('b2_disguise', 'Disguise', '/dɪsˈɡaɪz/', 'дисгайз', 'Маскировка / Маскировать', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Изменение внешности, чтобы не быть узнанным; скрытие чувств.',
    '- Внешность: "In disguise" (Замаскированный / В маскировке)\n- Идиома: "Blessing in disguise" (Нет худа без добра)\n- Глагол: "Disguise voice" (Изменить голос)',
    [
      { en: 'He wore a fake beard as a disguise.', ru: 'Он носил фальшивую бороду в качестве маскировки.' },
      { en: 'She tried to disguise her accent.', ru: 'Она пыталась скрыть свой акцент.' },
      { en: 'Losing my job was a blessing in disguise.', ru: 'Потеря работы стала благом, скрытым под маской неудачи (нет худа без добра).' },
      { en: 'It is impossible to disguise the truth forever.', ru: 'Невозможно скрывать правду вечно.' }
    ],
    []
  ),

  createRichWord('b2_dissolve', 'Dissolve', '/dɪˈzɒlv/', 'дизолв', 'Растворять(ся)', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Становиться частью жидкости; официально прекращать деятельность (парламента/брака).',
    '- Наука: "Dissolve sugar" (Растворять сахар)\n- Политика: "Dissolve parliament" (Распустить парламент)\n- Эмоции: "Dissolve into tears" (Разразиться слезами)',
    [
      { en: 'Sugar dissolves easily in hot water.', ru: 'Сахар легко растворяется в горячей воде.' },
      { en: 'The king decided to dissolve the parliament.', ru: 'Король решил распустить парламент.' },
      { en: 'Their marriage was dissolved last year.', ru: 'Их брак был расторгнут в прошлом году.' },
      { en: 'The tension dissolved when he laughed.', ru: 'Напряжение рассеялось, когда он засмеялся.' }
    ],
    []
  ),

  createRichWord('b2_distract', 'Distract', '/dɪˈstrækt/', 'дистрэкт', 'Отвлекать', ProficiencyLevel.B2, 'verb', 'High', 'Neutral',
    'Заставлять кого-то перестать уделять внимание чему-то.',
    '- Внимание: "Distract attention" (Отвлечь внимание)\n- Работа: "Don\'t distract me" (Не отвлекай меня)\n- Сущ: "Distraction" (Отвлекающий фактор)',
    [
      { en: 'Don\'t distract the driver.', ru: 'Не отвлекай водителя.' },
      { en: 'The noise outside distracted me from my work.', ru: 'Шум на улице отвлек меня от работы.' },
      { en: 'He tried to distract her with a toy.', ru: 'Он попытался отвлечь ее игрушкой.' },
      { en: 'Stop checking your phone, it distracts you.', ru: 'Перестань проверять телефон, это тебя отвлекает.' }
    ],
    []
  ),

  createRichWord('b2_dock', 'Dock', '/dɒk/', 'док', 'Причал / Док / Швартоваться', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Место в порту для кораблей; платформа для погрузки; причаливать (гл.).',
    '- Корабль: "Dry dock" (Сухой док)\n- Компьютер: "Docking station" (Док-станция)\n- Суд: "In the dock" (На скамье подсудимых)',
    [
      { en: 'The ship is waiting to dock.', ru: 'Корабль ожидает швартовки.' },
      { en: 'Workers were loading crates at the dock.', ru: 'Рабочие грузили ящики на причале.' },
      { en: 'The accused stood in the dock.', ru: 'Обвиняемый стоял на скамье подсудимых.' },
      { en: 'We walked along the docks at sunset.', ru: 'Мы гуляли по докам на закате.' }
    ],
    []
  ),
  createRichWord('b2_dome', 'Dome', '/dəʊm/', 'доум', 'Купол', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Крыша в форме половины шара.',
    '- Архитектура: "Golden dome" (Золотой купол)\n- Здание: "The Dome of the Rock" (Купол Скалы)\n- Форма: "Dome-shaped" (Куполообразный)',
    [
      { en: 'The cathedral has a magnificent dome.', ru: 'У собора есть великолепный купол.' },
      { en: 'We climbed to the top of the dome.', ru: 'Мы поднялись на вершину купола.' },
      { en: 'The stadium is covered by a huge dome.', ru: 'Стадион накрыт огромным куполом.' },
      { en: 'From a distance, you can see the golden dome.', ru: 'Издалека виден золотой купол.' }
    ],
    []
  ),

  createRichWord('b2_donor', 'Donor', '/ˈdəʊ.nər/', 'доунэр', 'Донор / Жертвователь', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Человек, который отдает что-то (кровь, органы, деньги) другим.',
    '- Медицина: "Blood donor" (Донор крови)\n- Органы: "Organ donor" (Донор органов)\n- Деньги: "Anonymous donor" (Анонимный жертвователь)',
    [
      { en: 'They are looking for a kidney donor.', ru: 'Они ищут донора почки.' },
      { en: 'The charity relies on generous donors.', ru: 'Благотворительность зависит от щедрых жертвователей.' },
      { en: 'He is a regular blood donor.', ru: 'Он регулярный донор крови.' },
      { en: 'A donor gave one million dollars to the school.', ru: 'Жертвователь передал школе один миллион долларов.' }
    ],
    []
  ),

  createRichWord('b2_drown', 'Drown', '/draʊn/', 'драун', 'Тонуть / Топить', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Умирать под водой из-за невозможности дышать; или заглушать звук.',
    '- Смерть: "Drown in the sea" (Утонуть в море)\n- Звук: "Drown out the noise" (Заглушить шум)\n- Переносное: "Drowning in work" (Тонуть в работе)',
    [
      { en: 'He almost drowned when he fell off the boat.', ru: 'Он чуть не утонул, когда упал с лодки.' },
      { en: 'The loud music drowned out our conversation.', ru: 'Громкая музыка заглушила наш разговор.' },
      { en: 'She saved the boy from drowning.', ru: 'Она спасла мальчика, который тонул.' },
      { en: 'I am drowning in paperwork right now.', ru: 'Я сейчас тону в бумажной работе.' }
    ],
    []
  ),

  createRichWord('b2_dynamic', 'Dynamic', '/daɪˈnæm.ɪk/', 'дайнэмик', 'Динамичный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Полный энергии и новых идей; постоянно меняющийся.',
    '- Личность: "Dynamic leader" (Динамичный лидер)\n- Процесс: "Dynamic market" (Динамичный рынок)\n- Экономика: "Dynamic economy" (Динамичная экономика)',
    [
      { en: 'He is a dynamic and ambitious young man.', ru: 'Он динамичный и амбициозный молодой человек.' },
      { en: 'The business world is very dynamic.', ru: 'Деловой мир очень динамичен.' },
      { en: 'We need a dynamic approach to sales.', ru: 'Нам нужен динамичный подход к продажам.' },
      { en: 'Group dynamics can be complicated.', ru: 'Групповая динамика может быть сложной.' }
    ],
    []
  ),

  createRichWord('b2_ecological', 'Ecological', '/ˌiː.kəˈlɒdʒ.ɪ.kəl/', 'иколоджикэл', 'Экологический', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Относящийся к окружающей среде и живым существам.',
    '- Проблема: "Ecological disaster" (Экологическая катастрофа)\n- Баланс: "Ecological balance" (Экологический баланс)\n- След: "Ecological footprint" (Экологический след)',
    [
      { en: 'The oil spill caused an ecological disaster.', ru: 'Разлив нефти вызвал экологическую катастрофу.' },
      { en: 'We must protect the ecological balance of the lake.', ru: 'Мы должны защитить экологический баланс озера.' },
      { en: 'Organic farming brings ecological benefits.', ru: 'Органическое земледелие приносит экологическую пользу.' },
      { en: 'They are studying the ecological impact of the dam.', ru: 'Они изучают экологическое воздействие дамбы.' }
    ],
    []
  ),

  createRichWord('b2_emperor', 'Emperor', '/ˈem.pər.ər/', 'эмпэрэ', 'Император', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Правитель империи (мужчина).',
    '- История: "Roman Emperor" (Римский император)\n- Животные: "Emperor penguin" (Императорский пингвин)\n- Титул: "The Emperor of Japan" (Император Японии)',
    [
      { en: 'Napoleon crowned himself Emperor.', ru: 'Наполеон короновал себя императором.' },
      { en: 'The Emperor ruled for fifty years.', ru: 'Император правил пятьдесят лет.' },
      { en: 'The Emperor penguin is the largest of all penguins.', ru: 'Императорский пингвин — самый крупный из всех пингвинов.' },
      { en: 'Statues of the emperor stood in every city.', ru: 'Статуи императора стояли в каждом городе.' }
    ],
    []
  ),

  createRichWord('b2_enclose', 'Enclose', '/ɪnˈkləʊz/', 'инклоуз', 'Окружать / Вкладывать', ProficiencyLevel.B2, 'verb', 'Low', 'Formal',
    'Окружать стеной или забором; вкладывать что-то в конверт с письмом.',
    '- Письмо: "Enclosed please find" (В приложении вы найдете...)\n- Территория: "Enclosed by a wall" (Окруженный стеной)\n- Пространство: "Enclosed space" (Замкнутое пространство)',
    [
      { en: 'The garden is enclosed by a high wall.', ru: 'Сад окружен высокой стеной.' },
      { en: 'I have enclosed a cheque with this letter.', ru: 'Я вложил чек в это письмо.' },
      { en: 'Please find enclosed my CV.', ru: 'В приложении вы найдете мое резюме.' },
      { en: 'Do you suffer from fear of enclosed spaces?', ru: 'Ты страдаешь от боязни замкнутых пространств?' }
    ],
    []
  ),

  createRichWord('b2_enlarge', 'Enlarge', '/ɪnˈlɑːdʒ/', 'инладщ', 'Увеличивать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Делать что-то больше (особенно фото или текст).',
    '- Фото: "Enlarge a photo" (Увеличить фото)\n- Текст: "Enlarge the font" (Увеличить шрифт)\n- Здание: "Enlarge the house" (Расширить дом)',
    [
      { en: 'Can you enlarge this photograph for me?', ru: 'Можешь увеличить эту фотографию для меня?' },
      { en: 'We plan to enlarge the kitchen next year.', ru: 'Мы планируем расширить кухню в следующем году.' },
      { en: 'Click to enlarge the image.', ru: 'Нажмите, чтобы увеличить изображение.' },
      { en: 'The gland was enlarged.', ru: 'Железа была увеличена.' }
    ],
    []
  ),

  createRichWord('b2_enrich', 'Enrich', '/ɪnˈrɪtʃ/', 'инрич', 'Обогащать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Улучшать качество чего-либо, добавляя что-то; делать богаче.',
    '- Опыт: "Enrich your life" (Обогатить свою жизнь)\n- Знания: "Enrich vocabulary" (Обогатить словарный запас)\n- Еда: "Enriched with vitamins" (Обогащенный витаминами)',
    [
      { en: 'Reading enriches your mind.', ru: 'Чтение обогащает твой разум.' },
      { en: 'Travel can enrich your life experience.', ru: 'Путешествия могут обогатить твой жизненный опыт.' },
      { en: 'The soil needs to be enriched with fertilizer.', ru: 'Почву нужно обогатить удобрением.' },
      { en: 'Uranium must be enriched for use in reactors.', ru: 'Уран должен быть обогащен для использования в реакторах.' }
    ],
    []
  ),

  createRichWord('b2_entrepreneur', 'Entrepreneur', '/ˌɒn.trə.prəˈnɜːr/', 'онтрэпранё', 'Предприниматель', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Человек, который начинает свой бизнес, принимая на себя финансовые риски.',
    '- Бизнес: "Successful entrepreneur" (Успешный предприниматель)\n- Дух: "Entrepreneurial spirit" (Предпринимательский дух)\n- Стартап: "Tech entrepreneur" (Технологический предприниматель)',
    [
      { en: 'He is a successful entrepreneur with three companies.', ru: 'Он успешный предприниматель с тремя компаниями.' },
      { en: 'Entrepreneurs take risks to create new products.', ru: 'Предприниматели идут на риск, чтобы создать новые продукты.' },
      { en: 'She wants to be an entrepreneur and be her own boss.', ru: 'Она хочет быть предпринимателем и сама себе начальником.' },
      { en: 'Silicon Valley is full of young entrepreneurs.', ru: 'Кремниевая долина полна молодых предпринимателей.' }
    ],
    []
  ),

  createRichWord('b2_envy', 'Envy', '/ˈen.vi/', 'энви', 'Зависть / Завидовать', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Чувство желания иметь то, что есть у другого (сущ.); желать чужого (гл.).',
    '- Чувство: "Green with envy" (Позеленевший от зависти)\n- Глагол: "I envy you" (Я тебе завидую)\n- Причина: "Object of envy" (Предмет зависти)',
    [
      { en: 'I envy her ability to speak four languages.', ru: 'Я завидую ее способности говорить на четырех языках.' },
      { en: 'He watched with envy as they drove away in a new car.', ru: 'Он с завистью смотрел, как они уезжают на новой машине.' },
      { en: 'Her beauty was the envy of the school.', ru: 'Ее красота была предметом зависти всей школы.' },
      { en: 'There is no need to envy others.', ru: 'Нет нужды завидовать другим.' }
    ],
    []
  ),

  createRichWord('b2_erupt', 'Erupt', '/ɪˈrʌpt/', 'ирапт', 'Извергаться / Вспыхивать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Взрываться (о вулкане); внезапно начинаться (о насилии/шуме).',
    '- Вулкан: "Volcano erupted" (Вулкан извергся)\n- Эмоции: "Erupt in laughter" (Взорваться смехом)\n- Конфликт: "Violence erupted" (Вспыхнуло насилие)',
    [
      { en: 'The volcano erupted, sending ash into the sky.', ru: 'Вулкан извергся, выбросив пепел в небо.' },
      { en: 'The crowd erupted in cheers when he scored.', ru: 'Толпа взорвалась криками, когда он забил.' },
      { en: 'Violence erupted in the city streets.', ru: 'На улицах города вспыхнуло насилие.' },
      { en: 'His skin erupted in a rash.', ru: 'Его кожа покрылась (вспыхнула) сыпью.' }
    ],
    []
  ),

  createRichWord('b2_escort', 'Escort', '/ɪˈskɔːt/', 'искот', 'Сопровождать / Эскорт', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Идти с кем-то для защиты или вежливости (гл.); охрана или спутник (сущ. /ˈes.kɔːt/).',
    '- Защита: "Police escort" (Полицейский эскорт)\n- Действие: "Escort to the door" (Проводить до двери)\n- Спутник: "Armed escort" (Вооруженное сопровождение)',
    [
      { en: 'Security guards escorted him out of the building.', ru: 'Охранники вывели (сопроводили) его из здания.' },
      { en: 'The President travelled with a police escort.', ru: 'Президент путешествовал с полицейским эскортом.' },
      { en: 'May I escort you to your car?', ru: 'Позвольте мне проводить вас до машины?' },
      { en: 'The ship was escorted by two destroyers.', ru: 'Корабль сопровождали два эсминца.' }
    ],
    []
  ),

  createRichWord('b2_essence', 'Essence', '/ˈes.əns/', 'эснс', 'Сущность / Суть', ProficiencyLevel.B2, 'noun', 'Low', 'Formal',
    'Самое важное качество чего-либо; экстракт.',
    '- Смысл: "In essence" (В сущности / По сути)\n- Время: "Time is of the essence" (Время не ждет / Время дорого)\n- Косметика: "Vanilla essence" (Ванильная эссенция)',
    [
      { en: 'In essence, we agree with your proposal.', ru: 'По сути, мы согласны с вашим предложением.' },
      { en: 'Trust is the essence of a good relationship.', ru: 'Доверие — это суть хороших отношений.' },
      { en: 'Speed is of the essence in this mission.', ru: 'Скорость имеет решающее значение в этой миссии.' },
      { en: 'She captured the essence of the landscape in her painting.', ru: 'Она уловила суть пейзажа в своей картине.' }
    ],
    []
  ),

  createRichWord('b2_ethical', 'Ethical', '/ˈeθ.ɪ.kəl/', 'эсикэл', 'Этический / Этичный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Связанный с моралью; правильный с моральной точки зрения.',
    '- Вопросы: "Ethical issues" (Этические вопросы)\n- Бизнес: "Ethical investment" (Этичные инвестиции)\n- Поведение: "Is it ethical?" (Это этично?)',
    [
      { en: 'The doctor faced a difficult ethical dilemma.', ru: 'Врач столкнулся с трудной этической дилеммой.' },
      { en: 'Is it ethical to experiment on animals?', ru: 'Этично ли проводить эксперименты над животными?' },
      { en: 'The company has a strong ethical code.', ru: 'У компании строгий этический кодекс.' },
      { en: 'We only buy fair trade and ethical products.', ru: 'Мы покупаем только товары справедливой торговли и этичные продукты.' }
    ],
    []
  ),

  createRichWord('b2_ethics', 'Ethics', '/ˈeθ.ɪks/', 'эсикс', 'Этика / Мораль', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Система моральных принципов; правила поведения.',
    '- Работа: "Work ethics" (Трудовая этика)\n- Наука: "Medical ethics" (Медицинская этика)\n- Кодекс: "Code of ethics" (Кодекс этики)',
    [
      { en: 'His business ethics are questionable.', ru: 'Его деловая этика вызывает вопросы.' },
      { en: 'Journalists follow a code of ethics.', ru: 'Журналисты следуют кодексу этики.' },
      { en: 'Ethics deals with what is right and wrong.', ru: 'Этика занимается тем, что правильно, а что нет.' },
      { en: 'He is a man of high ethics.', ru: 'Он человек высокой морали.' }
    ],
    []
  ),

  createRichWord('b2_evacuate', 'Evacuate', '/ɪˈvæk.ju.eɪt/', 'ивэкьюэйт', 'Эвакуировать', ProficiencyLevel.B2, 'verb', 'Low', 'Neutral',
    'Уводить людей из опасного места; покидать здание.',
    '- Опасность: "Evacuate the building" (Эвакуировать здание)\n- Люди: "Evacuate residents" (Эвакуировать жителей)\n- Приказ: "Order to evacuate" (Приказ об эвакуации)',
    [
      { en: 'Residents were ordered to evacuate due to the fire.', ru: 'Жителям приказали эвакуироваться из-за пожара.' },
      { en: 'The building was evacuated immediately.', ru: 'Здание было эвакуировано немедленно.' },
      { en: 'They plan to evacuate the whole village.', ru: 'Они планируют эвакуировать всю деревню.' },
      { en: 'Employees evacuated calmly during the drill.', ru: 'Сотрудники спокойно эвакуировались во время учений.' }
    ],
    []
  ),

  createRichWord('b2_eve', 'Eve', '/iːv/', 'ив', 'Канун', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'День или вечер перед событием (часто праздником).',
    '- Праздник: "New Year\'s Eve" (Канун Нового года)\n- Рождество: "Christmas Eve" (Сочельник)\n- Событие: "On the eve of" (Накануне)',
    [
      { en: 'We always have a party on New Year\'s Eve.', ru: 'У нас всегда вечеринка в канун Нового года.' },
      { en: 'He was nervous on the eve of the exam.', ru: 'Он нервничал накануне экзамена.' },
      { en: 'They met on Christmas Eve.', ru: 'Они встретились в Сочельник.' },
      { en: 'On the eve of the battle, the soldiers rested.', ru: 'Накануне битвы солдаты отдыхали.' }
    ],
    []
  ),

  createRichWord('b2_evenly', 'Evenly', '/ˈiː.vən.li/', 'ивэнли', 'Равномерно / Поровну', ProficiencyLevel.B2, 'adv', 'Low', 'Neutral',
    'Равными частями или на равном расстоянии.',
    '- Распределение: "Evenly distributed" (Равномерно распределенный)\n- Деньги: "Split evenly" (Разделить поровну)\n- Спорт: "Evenly matched" (Равные по силе)',
    [
      { en: 'Spread the butter evenly on the toast.', ru: 'Равномерно намажь масло на тост.' },
      { en: 'The money was divided evenly among the three sons.', ru: 'Деньги были разделены поровну между тремя сыновьями.' },
      { en: 'The two teams are very evenly matched.', ru: 'Две команды очень равны по силе.' },
      { en: 'Bake until evenly browned.', ru: 'Выпекайте до равномерного подрумянивания.' }
    ],
    []
  ),

  createRichWord('b2_exaggerate', 'Exaggerate', '/ɪɡˈzædʒ.ə.reɪt/', 'игзэджэрейт', 'Преувеличивать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Делать что-то больше, хуже или лучше, чем это есть на самом деле.',
    '- Речь: "Don\'t exaggerate" (Не преувеличивай)\n- Проблема: "Exaggerate the problem" (Раздувать проблему)\n- Важность: "Exaggerated importance" (Преувеличенная важность)',
    [
      { en: 'He tends to exaggerate his achievements.', ru: 'Он склонен преувеличивать свои достижения.' },
      { en: 'Stop exaggerating, it wasn\'t that bad.', ru: 'Перестань преувеличивать, все было не так уж плохо.' },
      { en: 'The media exaggerated the danger.', ru: 'СМИ преувеличили опасность.' },
      { en: 'I\'m not exaggerating when I say he is a genius.', ru: 'Я не преувеличиваю, когда говорю, что он гений.' }
    ],
    []
  ),

  createRichWord('b2_exclaim', 'Exclaim', '/ɪkˈskleɪm/', 'иксклейм', 'Восклицать', ProficiencyLevel.B2, 'verb', 'Low', 'Literary',
    'Сказать что-то громко и внезапно из-за удивления, гнева или радости.',
    '- Эмоция: "Exclaim in surprise" (Воскликнуть от удивления)\n- Удовольствие: "Exclaim with delight" (Воскликнуть от восторга)\n- Грамматика: "Exclamation mark" (Восклицательный знак)',
    [
      { en: '"What a beautiful view!" she exclaimed.', ru: '"Какой прекрасный вид!" — воскликнула она.' },
      { en: 'He exclaimed that he was innocent.', ru: 'Он воскликнул, что невиновен.' },
      { en: 'They exclaimed with joy when they saw the puppy.', ru: 'Они воскликнули от радости, увидев щенка.' },
      { en: '"Watch out!" he exclaimed suddenly.', ru: '"Берегись!" — воскликнул он внезапно.' }
    ],
    []
  ),

  createRichWord('b2_exotic', 'Exotic', '/ɪɡˈzɒt.ɪk/', 'игзотик', 'Экзотический', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Необычный и интересный, обычно потому что из далекой страны.',
    '- Еда: "Exotic fruit" (Экзотические фрукты)\n- Место: "Exotic location" (Экзотическое место)\n- Животные: "Exotic pets" (Экзотические питомцы)',
    [
      { en: 'They travelled to exotic locations in Asia.', ru: 'Они путешествовали по экзотическим местам в Азии.' },
      { en: 'The garden is full of exotic plants.', ru: 'Сад полон экзотических растений.' },
      { en: 'She likes to cook exotic dishes.', ru: 'Она любит готовить экзотические блюда.' },
      { en: 'He has an exotic taste in clothes.', ru: 'У него экзотический вкус в одежде.' }
    ],
    []
  ),

  createRichWord('b2_expedition', 'Expedition', '/ˌek.spəˈdɪʃ.ən/', 'экспедишн', 'Экспедиция', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Организованное путешествие с определенной целью (научной или военной).',
    '- Путешествие: "Go on an expedition" (Отправиться в экспедицию)\n- Место: "Polar expedition" (Полярная экспедиция)\n- Цель: "Scientific expedition" (Научная экспедиция)',
    [
      { en: 'They are planning an expedition to the South Pole.', ru: 'Они планируют экспедицию на Южный полюс.' },
      { en: 'The expedition team faced many dangers.', ru: 'Команда экспедиции столкнулась со многими опасностями.' },
      { en: 'He led a climbing expedition in the Himalayas.', ru: 'Он возглавлял альпинистскую экспедицию в Гималаях.' },
      { en: 'We went on a shopping expedition to the city.', ru: 'Мы отправились в "поход" по магазинам в город.' }
    ],
    []
  ),

  createRichWord('b2_expertise', 'Expertise', '/ˌek.spɜːˈtiːz/', 'экспётиз', 'Экспертиза / Компетентность', ProficiencyLevel.B2, 'noun', 'Low', 'Formal',
    'Высокий уровень знаний или навыков в определенной области.',
    '- Знания: "Technical expertise" (Технические знания)\n- Область: "Area of expertise" (Область компетенции)\n- Потребность: "Need expertise" (Нуждаться в экспертных знаниях)',
    [
      { en: 'We need someone with legal expertise.', ru: 'Нам нужен кто-то с юридическими знаниями.' },
      { en: 'She has considerable expertise in finance.', ru: 'У нее значительная компетенция в финансах.' },
      { en: 'His expertise helped us solve the problem.', ru: 'Его экспертные знания помогли нам решить проблему.' },
      { en: 'I am afraid this is outside my area of expertise.', ru: 'Боюсь, это вне моей области компетенции.' }
    ],
    []
  ),
  createRichWord('b2_disapprove', 'Disapprove', '/ˌdɪs.əˈpruːv/', 'дисэпрув', 'Не одобрять / Осуждать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Считать, что кто-то или что-то является плохим, неправильным или неподходящим.',
    '- Мнение: "Strongly disapprove" (Категорически не одобрять)\n- Поведение: "Disapprove of smoking" (Не одобрять курение)\n- Родители: "Parents disapprove" (Родители не одобряют)',
    [
      { en: 'Her parents disapprove of her new boyfriend.', ru: 'Ее родители не одобряют ее нового парня.' },
      { en: 'I strongly disapprove of violence in any form.', ru: 'Я категорически не одобряю насилие в любой форме.' },
      { en: 'The teacher disapproved of their bad behaviour.', ru: 'Учитель осудил их плохое поведение.' },
      { en: 'He shook his head to show he disapproved.', ru: 'Он покачал головой, чтобы показать свое неодобрение.' }
    ],
    []
  ),

  createRichWord('b2_disgrace', 'Disgrace', '/dɪsˈɡreɪs/', 'дисгрейс', 'Позор / Бесчестие', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Потеря уважения и чести; состояние, когда за тебя стыдно.',
    '- Состояние: "In disgrace" (В немилости / С позором)\n- Оценка: "It is a disgrace" (Это позор)\n- Семья: "Bring disgrace on" (Навлечь позор на)',
    [
      { en: 'His behaviour brought disgrace on the whole family.', ru: 'Его поведение навлекло позор на всю семью.' },
      { en: 'It is a disgrace that the hospital is so dirty.', ru: 'Это позор, что больница такая грязная.' },
      { en: 'He was sent home in disgrace.', ru: 'Его отправили домой с позором.' },
      { en: 'She is a disgrace to her profession.', ru: 'Она — позор для своей профессии.' }
    ],
    [
      { meaning: "To harm reputation (verb)", translation: "Позорить", example: { en: "Do not disgrace yourself.", ru: "Не позорься." } }
    ]
  ),

  createRichWord('b2_ditch', 'Ditch', '/dɪtʃ/', 'дитч', 'Канава / Бросать (разг.)', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Длинное узкое углубление в земле для воды (сущ.); избавиться от чего-то или кого-то (гл., разг.).',
    '- Дорога: "Dig a ditch" (Копать канаву)\n- Разговорный: "Ditch school" (Прогуливать школу)\n- Отношения: "Ditch a boyfriend" (Бросить парня)',
    [
      { en: ' The car slid off the road into a ditch.', ru: 'Машина соскользнула с дороги в канаву.' },
      { en: 'Farmers dug ditches to drain the fields.', ru: 'Фермеры вырыли канавы, чтобы осушить поля.' },
      { en: 'He decided to ditch his old car and buy a new one.', ru: 'Он решил избавиться от своей старой машины и купить новую.' },
      { en: 'Let\'s ditch class and go to the cinema.', ru: 'Давай прогуляем урок и пойдем в кино.' }
    ],
    []
  ),

  createRichWord('b2_divert', 'Divert', '/daɪˈvɜːt/', 'дайвёт', 'Отвлекать / Перенаправлять', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Изменить направление чего-либо; заставить кого-то думать о чем-то другом.',
    '- Транспорт: "Divert traffic" (Перенаправлять движение)\n- Внимание: "Divert attention" (Отвлекать внимание)\n- Рейс: "Flight diverted" (Рейс перенаправлен)',
    [
      { en: 'Traffic was diverted because of the accident.', ru: 'Движение было перенаправлено из-за аварии.' },
      { en: 'He tried to divert her attention from the surprise.', ru: 'Он пытался отвлечь ее внимание от сюрприза.' },
      { en: 'The river was diverted to irrigate the crops.', ru: 'Реку отвели для орошения посевов.' },
      { en: 'Nothing can divert him from his goal.', ru: 'Ничто не может отвлечь его от цели.' }
    ],
    []
  ),

  createRichWord('b2_dreadful', 'Dreadful', '/ˈdred.fəl/', 'дредфул', 'Ужасный / Страшный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Очень плохой, неприятный или низкого качества.',
    '- Погода: "Dreadful weather" (Ужасная погода)\n- Ошибка: "Dreadful mistake" (Страшная ошибка)\n- Самочувствие: "Feel dreadful" (Чувствовать себя ужасно)',
    [
      { en: 'What a dreadful thing to say!', ru: 'Какая ужасная вещь, чтобы такое говорить!' },
      { en: 'The weather has been dreadful all week.', ru: 'Погода была ужасной всю неделю.' },
      { en: 'I feel dreadful about forgetting your birthday.', ru: 'Я чувствую себя ужасно из-за того, что забыл твой день рождения.' },
      { en: 'They made a dreadful mess in the kitchen.', ru: 'Они устроили страшный беспорядок на кухне.' }
    ],
    []
  ),

  createRichWord('b2_drought', 'Drought', '/draʊt/', 'драут', 'Засуха', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Длительный период времени, когда выпадает мало или совсем нет дождя.',
    '- Природа: "Severe drought" (Сильная засуха)\n- Урожай: "Caused by drought" (Вызвано засухой)\n- Климат: "Period of drought" (Период засухи)',
    [
      { en: 'The drought caused the crops to fail.', ru: 'Засуха привела к гибели урожая.' },
      { en: 'Farmers are worried about the continuing drought.', ru: 'Фермеры обеспокоены продолжающейся засухой.' },
      { en: 'Water was rationed during the drought.', ru: 'Во время засухи вода выдавалась нормировано.' },
      { en: 'Forest fires are common during a drought.', ru: 'Лесные пожары обычны во время засухи.' }
    ],
    []
  ),

  createRichWord('b2_drunken', 'Drunken', '/ˈdrʌŋ.kən/', 'дранкэн', 'Пьяный / Нетрезвый', ProficiencyLevel.B2, 'adj', 'Low', 'Neutral',
    'Находящийся под воздействием алкоголя (используется перед существительным).',
    '- Поведение: "Drunken behavior" (Пьяное поведение)\n- Состояние: "Drunken stupor" (Пьяный ступор)\n- Вождение: "Drunken driving" (Вождение в нетрезвом виде)',
    [
      { en: 'He was arrested for drunken driving.', ru: 'Его арестовали за вождение в нетрезвом виде.' },
      { en: 'They got into a drunken brawl at the pub.', ru: 'Они ввязались в пьяную драку в пабе.' },
      { en: 'She regrets her drunken phone calls.', ru: 'Она жалеет о своих пьяных телефонных звонках.' },
      { en: 'A drunken man was singing in the street.', ru: 'Пьяный мужчина пел на улице.' }
    ],
    []
  ),

  createRichWord('b2_dumb', 'Dumb', '/dʌm/', 'дам', 'Глупый / Немой', ProficiencyLevel.B2, 'adj', 'Medium', 'Informal',
    'Глупый (разговорное); или физически неспособный говорить (устаревающее/медицинское).',
    '- Интеллект: "Play dumb" (Притворяться глупым)\n- Речь: "Struck dumb" (Онеметь от удивления)\n- Вопрос: "Dumb question" (Глупый вопрос)',
    [
      { en: 'That was a pretty dumb thing to do.', ru: 'Это был довольно глупый поступок.' },
      { en: 'Don\'t play dumb with me!', ru: 'Не прикидывайся дурачком со мной!' },
      { en: 'He was struck dumb with amazement.', ru: 'Он онемел от изумления.' },
      { en: 'Are we legally allowed to use "dumb" for mute?', ru: 'Разрешено ли нам юридически использовать слово "dumb" для обозначения немоты?' }
    ],
    []
  ),

  createRichWord('b2_ecology', 'Ecology', '/iˈkɒl.ə.dʒi/', 'иколоджи', 'Экология', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Наука о взаимодействии живых организмов и окружающей среды.',
    '- Наука: "Study ecology" (Изучать экологию)\n- Природа: "Marine ecology" (Морская экология)\n- Защита: "Fragile ecology" (Хрупкая экология)',
    [
      { en: 'Pollution damages the local ecology.', ru: 'Загрязнение вредит местной экологии.' },
      { en: 'She is studying plant ecology at university.', ru: 'Она изучает экологию растений в университете.' },
      { en: 'We must protect the ecology of the rainforest.', ru: 'Мы должны защищать экологию тропических лесов.' },
      { en: 'Tourism can upset the delicate ecology of the island.', ru: 'Туризм может нарушить хрупкую экологию острова.' }
    ],
    []
  ),

  createRichWord('b2_elastic', 'Elastic', '/iˈlæs.tɪk/', 'илэстик', 'Эластичный / Резинка', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Способный растягиваться и возвращаться в форму; гибкий (прил.); резинка (сущ.).',
    '- Материал: "Elastic band" (Резинка)\n- Одежда: "Elastic waist" (Эластичный пояс)\n- Свойство: "Highly elastic" (Очень эластичный)',
    [
      { en: 'This material is very elastic.', ru: 'Этот материал очень эластичный.' },
      { en: 'I need an elastic band to hold these papers.', ru: 'Мне нужна резинка, чтобы скрепить эти бумаги.' },
      { en: 'The demand for luxury goods is rarely elastic.', ru: 'Спрос на предметы роскоши редко бывает эластичным (гибким).' },
      { en: 'My trousers have an elastic waist.', ru: 'У моих брюк эластичный пояс.' }
    ],
    []
  ),

  createRichWord('b2_elf', 'Elf', '/elf/', 'элф', 'Эльф', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Маленькое волшебное существо с острыми ушами из сказок.',
    '- Сказки: "Santa\'s elves" (Эльфы Санты)\n- Фэнтези: "High elf" (Высший эльф)\n- Внешность: "Elf ears" (Эльфийские уши)',
    [
      { en: 'In the story, the elf helped the shoemaker.', ru: 'В сказке эльф помог сапожнику.' },
      { en: 'Santa Claus has many elves making toys.', ru: 'У Санта-Клауса много эльфов, делающих игрушки.' },
      { en: 'She dressed up as an elf for Halloween.', ru: 'Она нарядилась эльфом на Хэллоуин.' },
      { en: 'Elves are often depicted as immortal.', ru: 'Эльфов часто изображают бессмертными.' }
    ],
    []
  ),

  createRichWord('b2_emigrate', 'Emigrate', '/ˈem.ɪ.ɡreɪt/', 'эмигрейт', 'Эмигрировать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Покинуть свою страну, чтобы жить в другой.',
    '- Действие: "Emigrate to Canada" (Эмигрировать в Канаду)\n- Причина: "Emigrate for work" (Эмигрировать ради работы)\n- История: "Family emigrated" (Семья эмигрировала)',
    [
      { en: 'His grandparents emigrated from Italy in 1950.', ru: 'Его бабушка и дедушка эмигрировали из Италии в 1950 году.' },
      { en: 'Many people emigrate to find better jobs.', ru: 'Многие люди эмигрируют, чтобы найти лучшую работу.' },
      { en: 'They plan to emigrate to Australia next year.', ru: 'Они планируют эмигрировать в Австралию в следующем году.' },
      { en: 'Emigrating is a huge life decision.', ru: 'Эмиграция — это огромное жизненное решение.' }
    ],
    []
  ),
  createRichWord('b2_enquire', 'Enquire', '/ɪnˈkwaɪər/', 'инквайэ', 'Спрашивать / Узнавать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Задавать вопросы, чтобы получить информацию (британский вариант inquire).',
    '- Информация: "Enquire about" (Узнавать о)\n- Здоровье: "Enquire after health" (Справляться о здоровье)\n- Место: "Enquire within" (Узнавать внутри)',
    [
      { en: 'I am writing to enquire about the job vacancy.', ru: 'Я пишу, чтобы узнать о вакансии.' },
      { en: 'She enquired whether tickets were still available.', ru: 'Она спросила, есть ли еще билеты.' },
      { en: '"Is something wrong?" he enquired politely.', ru: '"Что-то не так?" — вежливо поинтересовался он.' },
      { en: 'You should enquire at the reception desk.', ru: 'Вам следует узнать на стойке регистрации.' }
    ],
    []
  ),

  createRichWord('b2_epic', 'Epic', '/ˈep.ɪk/', 'эпик', 'Эпический / Грандиозный', ProficiencyLevel.B2, 'adj', 'Low', 'Neutral',
    'Очень длинный и насыщенный событиями (о фильме/книге); грандиозный или героический.',
    '- Кино: "Epic movie" (Эпический фильм)\n- Путешествие: "Epic journey" (Грандиозное путешествие)\n- Разговорный: "Epic fail" (Полный провал)',
    [
      { en: 'We watched an epic movie about the Roman Empire.', ru: 'Мы смотрели эпический фильм о Римской империи.' },
      { en: 'Their journey across the ocean was truly epic.', ru: 'Их путешествие через океан было поистине грандиозным.' },
      { en: 'The book tells the epic story of survival.', ru: 'Книга рассказывает эпическую историю выживания.' },
      { en: 'That party was absolutely epic!', ru: 'Та вечеринка была просто грандиозной!' }
    ],
    [
      { meaning: "Long poem (noun)", translation: "Эпос / Поэма", example: { en: "Homer's Iliad is an epic.", ru: "Илиада Гомера — это эпос." } }
    ]
  ),

  createRichWord('b2_epidemic', 'Epidemic', '/ˌep.ɪˈdem.ɪk/', 'эпидемик', 'Эпидемия', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Быстрое распространение инфекционного заболевания среди большого количества людей.',
    '- Болезнь: "Flu epidemic" (Эпидемия гриппа)\n- Масштаб: "Global epidemic" (Глобальная эпидемия)\n- Переносное: "Epidemic of crime" (Эпидемия/всплеск преступности)',
    [
      { en: 'The government is trying to stop the epidemic.', ru: 'Правительство пытается остановить эпидемию.' },
      { en: 'A flu epidemic closed the schools for a week.', ru: 'Эпидемия гриппа закрыла школы на неделю.' },
      { en: 'Doctors are warning of a new epidemic.', ru: 'Врачи предупреждают о новой эпидемии.' },
      { en: 'Obesity has become an epidemic in some countries.', ru: 'Ожирение стало эпидемией в некоторых странах.' }
    ],
    []
  ),

  createRichWord('b2_eternal', 'Eternal', '/ɪˈtɜː.nəl/', 'итёрнл', 'Вечный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Существующий всегда или очень долго; нескончаемый.',
    '- Любовь: "Eternal love" (Вечная любовь)\n- Время: "Eternal life" (Вечная жизнь)\n- Качество: "Eternal optimist" (Неисправимый оптимист)',
    [
      { en: 'They promised each other eternal love.', ru: 'Они обещали друг другу вечную любовь.' },
      { en: 'She believes in the eternal soul.', ru: 'Она верит в вечную душу.' },
      { en: 'I am tired of his eternal complaining.', ru: 'Я устал от его бесконечных (вечных) жалоб.' },
      { en: 'Rome is often called the Eternal City.', ru: 'Рим часто называют Вечным городом.' }
    ],
    []
  ),

  createRichWord('b2_evaporate', 'Evaporate', '/ɪˈvæp.ər.eɪt/', 'ивэпэрейт', 'Испаряться', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Превращаться из жидкости в пар; исчезать (о надеждах, чувствах).',
    '- Жидкость: "Water evaporates" (Вода испаряется)\n- Солнце: "Sun evaporates moisture" (Солнце испаряет влагу)\n- Переносное: "Hopes evaporated" (Надежды испарились)',
    [
      { en: 'Water evaporates when it boils.', ru: 'Вода испаряется, когда кипит.' },
      { en: 'The puddle evaporated in the sun.', ru: 'Лужа испарилась на солнце.' },
      { en: 'His anger evaporated when he saw her smile.', ru: 'Его гнев испарился, когда он увидел ее улыбку.' },
      { en: 'Their savings evaporated during the crisis.', ru: 'Их сбережения испарились во время кризиса.' }
    ],
    []
  ),

  createRichWord('b2_expire', 'Expire', '/ɪkˈspaɪər/', 'икспайэ', 'Истекать (о сроке) / Умирать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Заканчиваться (о периоде действия документа, контракта); умереть (формально).',
    '- Документ: "Passport expires" (Срок действия паспорта истекает)\n- Контракт: "Contract expired" (Контракт истек)\n- Еда: "Expiry date" (Срок годности)',
    [
      { en: 'My passport expires next month.', ru: 'Срок действия моего паспорта истекает в следующем месяце.' },
      { en: 'The coupon has already expired.', ru: 'Купон уже просрочен.' },
      { en: 'You must renew your membership before it expires.', ru: 'Вы должны продлить членство до того, как оно истечет.' },
      { en: 'The patient expired early this morning.', ru: 'Пациент скончался сегодня рано утром.' }
    ],
    []
  ),

  createRichWord('b2_exterior', 'Exterior', '/ɪkˈstɪə.ri.ər/', 'икстириэ', 'Внешний / Внешность', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Внешняя сторона или поверхность чего-либо; внешний вид.',
    '- Здание: "Exterior walls" (Внешние стены)\n- Вид: "Tough exterior" (Суровая внешность)\n- Дизайн: "Exterior design" (Экстерьер)',
    [
      { en: 'The exterior of the house needs painting.', ru: 'Внешняя часть дома нуждается в покраске.' },
      { en: 'Behind his tough exterior, he is very kind.', ru: 'За его суровой внешностью скрывается доброта.' },
      { en: 'The car has a stylish exterior.', ru: 'У машины стильный экстерьер.' },
      { en: 'We filmed the exterior scenes in London.', ru: 'Мы снимали уличные (внешние) сцены в Лондоне.' }
    ],
    [
      { meaning: "Outer (Adjective)", translation: "Внешний / Наружный", example: { en: "Exterior doors.", ru: "Наружные двери." } }
    ]
  ),

  createRichWord('b2_extinct', 'Extinct', '/ɪkˈstɪŋkt/', 'икстинкт', 'Вымерший', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Больше не существующий (о видах животных или растений); потухший (о вулкане).',
    '- Животные: "Become extinct" (Вымереть)\n- Вулкан: "Extinct volcano" (Потухший вулкан)\n- Виды: "Extinct species" (Вымершие виды)',
    [
      { en: 'Dinosaurs became extinct millions of years ago.', ru: 'Динозавры вымерли миллионы лет назад.' },
      { en: 'Many species are in danger of becoming extinct.', ru: 'Многие виды находятся под угрозой вымирания.' },
      { en: 'The volcano has been extinct for centuries.', ru: 'Вулкан потух уже столетия назад.' },
      { en: 'We must protect rare animals from going extinct.', ru: 'Мы должны защищать редких животных от вымирания.' }
    ],
    []
  ),

  createRichWord('b2_facial', 'Facial', '/ˈfeɪ.ʃəl/', 'фейшл', 'Лицевой / Уход за лицом', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Относящийся к лицу (прил.); косметическая процедура для лица (сущ.).',
    '- Лицо: "Facial expression" (Выражение лица)\n- Волосы: "Facial hair" (Растительность на лице)\n- Косметика: "Get a facial" (Сделать чистку лица)',
    [
      { en: 'His facial expression showed his anger.', ru: 'Выражение его лица выдавало гнев.' },
      { en: 'He decided to grow some facial hair.', ru: 'Он решил отрастить бороду (растительность на лице).' },
      { en: 'She went to the spa for a facial.', ru: 'Она пошла в спа на процедуру для лица.' },
      { en: 'Facial recognition technology is common now.', ru: 'Технология распознавания лиц сейчас распространена.' }
    ],
    []
  ),

  createRichWord('b2_factual', 'Factual', '/ˈfæk.tʃu.əl/', 'фэкчуэл', 'Фактический', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Основанный на фактах; реальный, а не выдуманный.',
    '- Информация: "Factual errors" (Фактические ошибки)\n- Текст: "Factual report" (Фактический отчет)\n- Основа: "Factual basis" (Фактическая основа)',
    [
      { en: 'The report contains several factual errors.', ru: 'Отчет содержит несколько фактических ошибок.' },
      { en: 'I need factual information, not opinions.', ru: 'Мне нужна фактическая информация, а не мнения.' },
      { en: 'Is this story factual or fictional?', ru: 'Эта история реальная или вымышленная?' },
      { en: 'She gave a factual account of the accident.', ru: 'Она дала основанный на фактах отчет об аварии.' }
    ],
    []
  ),

  createRichWord('b2_festive', 'Festive', '/ˈfes.tɪv/', 'фестив', 'Праздничный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Веселый и радостный, подходящий для праздника.',
    '- Атмосфера: "Festive atmosphere" (Праздничная атмосфера)\n- Сезон: "Festive season" (Праздничный сезон / Рождество)\n- Настроение: "Festive mood" (Праздничное настроение)',
    [
      { en: 'The house looks very festive with all the lights.', ru: 'Дом выглядит очень празднично со всеми этими огнями.' },
      { en: 'We are getting into the festive spirit.', ru: 'Мы проникаемся праздничным духом.' },
      { en: 'Have a happy festive season!', ru: 'Счастливых праздников!' },
      { en: 'The table was set for a festive dinner.', ru: 'Стол был накрыт для праздничного ужина.' }
    ],
    []
  ),

  createRichWord('b2_foam', 'Foam', '/fəʊm/', 'фоум', 'Пена / Поролон', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Масса мелких пузырьков на поверхности жидкости; мягкий губчатый материал.',
    '- Море: "Sea foam" (Морская пена)\n- Бритье: "Shaving foam" (Пена для бритья)\n- Материал: "Memory foam" (Пена с памятью формы)',
    [
      { en: 'The waves crashed, creating white foam.', ru: 'Волны разбивались, создавая белую пену.' },
      { en: 'I need to buy some shaving foam.', ru: 'Мне нужно купить пену для бритья.' },
      { en: 'The mattress is made of memory foam.', ru: 'Матрас сделан из пены с памятью формы.' },
      { en: 'Firefighters used foam to put out the fire.', ru: 'Пожарные использовали пену, чтобы потушить огонь.' }
    ],
    []
  ),

  createRichWord('b2_foil', 'Foil', '/fɔɪl/', 'фойл', 'Фольга', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Очень тонкий лист металла, используемый для упаковки еды.',
    '- Кухня: "Aluminium foil" (Алюминиевая фольга)\n- Упаковка: "Wrapped in foil" (Завернутый в фольгу)\n- Металл: "Silver foil" (Серебряная фольга)',
    [
      { en: 'Wrap the chicken in foil before cooking.', ru: 'Заверните курицу в фольгу перед готовкой.' },
      { en: 'We used foil to keep the sandwiches fresh.', ru: 'Мы использовали фольгу, чтобы сохранить сэндвичи свежими.' },
      { en: 'The chocolate was wrapped in gold foil.', ru: 'Шоколад был завернут в золотую фольгу.' },
      { en: 'Do you have a roll of aluminium foil?', ru: 'У тебя есть рулон алюминиевой фольги?' }
    ],
    [
      { meaning: "To prevent success (verb - C2)", translation: "Срывать (планы)", example: { en: "The police foiled the plot.", ru: "Полиция сорвала заговор." } }
    ]
  ),

  createRichWord('b2_fury', 'Fury', '/ˈfjʊə.ri/', 'фьюри', 'Ярость / Бешенство', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Крайне сильный гнев.',
    '- Эмоция: "Fly into a fury" (Впасть в ярость)\n- Интенсивность: "Blind fury" (Слепая ярость)\n- Природа: "Fury of the storm" (Ярость шторма)',
    [
      { en: 'Her face was pale with fury.', ru: 'Ее лицо побледнело от ярости.' },
      { en: 'He shouted in a fit of fury.', ru: 'Он закричал в приступе ярости.' },
      { en: 'We faced the full fury of the storm.', ru: 'Мы столкнулись с полной яростью шторма.' },
      { en: 'His fury subsided after a while.', ru: 'Его ярость утихла через некоторое время.' }
    ],
    []
  ),

  createRichWord('b2_fuss', 'Fuss', '/fʌs/', 'фас', 'Суета / Шумиха', ProficiencyLevel.B2, 'noun', 'Medium', 'Informal',
    'Излишнее волнение или активность по пустякам.',
    '- Реакция: "Make a fuss" (Поднимать шум/суетиться)\n- Событие: "What is the fuss about?" (Из-за чего весь сыр-бор?)\n- Глагол: "Stop fussing" (Перестань суетиться)',
    [
      { en: 'She made a big fuss about the broken cup.', ru: 'Она подняла большой шум из-за разбитой чашки.' },
      { en: 'I don\'t want any fuss for my birthday.', ru: 'Я не хочу никакой суеты на свой день рождения.' },
      { en: 'Stop fussing with your hair!', ru: 'Перестань возиться со своими волосами!' },
      { en: 'What is all the fuss about?', ru: 'Из-за чего вся эта шумиха?' }
    ],
    []
  ),

  createRichWord('b2_generals', 'Generals', '/ˈdʒen.ər.əlz/', 'дженэрэлз', 'Генералы', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Офицеры очень высокого ранга в армии (множественное число от General).',
    '- Армия: "Army generals" (Армейские генералы)\n- Командование: "Top generals" (Высшие генералы)\n- История: "Famous generals" (Знаменитые генералы)',
    [
      { en: 'The generals met to discuss the strategy.', ru: 'Генералы встретились, чтобы обсудить стратегию.' },
      { en: 'He was one of the most respected generals.', ru: 'Он был одним из самых уважаемых генералов.' },
      { en: 'Generals command large armies.', ru: 'Генералы командуют большими армиями.' },
      { en: 'Two generals signed the peace treaty.', ru: 'Два генерала подписали мирный договор.' }
    ],
    []
  ),

  createRichWord('b2_generator', 'Generator', '/ˈdʒen.ər.eɪ.tər/', 'дженерейтэ', 'Генератор', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Машина, производящая электричество.',
    '- Электричество: "Power generator" (Электрогенератор)\n- Авария: "Backup generator" (Резервный генератор)\n- Тип: "Diesel generator" (Дизельный генератор)',
    [
      { en: 'We used a generator during the power cut.', ru: 'Мы использовали генератор во время отключения электричества.' },
      { en: 'The hospital has a backup generator.', ru: 'В больнице есть резервный генератор.' },
      { en: 'This generator runs on diesel.', ru: 'Этот генератор работает на дизеле.' },
      { en: 'The noise of the generator was annoying.', ru: 'Шум генератора раздражал.' }
    ],
    []
  ),

  createRichWord('b2_gig', 'Gig', '/ɡɪɡ/', 'гиг', 'Концерт / Подработка', ProficiencyLevel.B2, 'noun', 'Medium', 'Informal',
    'Выступление музыкантов (концерт); или временная работа.',
    '- Музыка: "Play a gig" (Играть концерт)\n- Работа: "Gig economy" (Гиг-экономика / работа по контрактам)\n- Событие: "Live gig" (Живое выступление)',
    [
      { en: 'The band has a gig in London tonight.', ru: 'У группы сегодня концерт в Лондоне.' },
      { en: 'He got a gig as a delivery driver.', ru: 'Он получил подработку водителем доставки.' },
      { en: 'I am going to a jazz gig later.', ru: 'Я иду на джазовый концерт позже.' },
      { en: 'Getting paid per gig is common now.', ru: 'Оплата за каждый заказ (гиг) сейчас распространена.' }
    ],
    []
  ),

  createRichWord('b2_giggle', 'Giggle', '/ˈɡɪɡ.əl/', 'гигл', 'Хихикать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Смеяться тихим, часто глупым или нервным образом.',
    '- Звук: "Nervous giggle" (Нервный смешок)\n- Реакция: "Start to giggle" (Начать хихикать)\n- Люди: "Children giggle" (Дети хихикают)',
    [
      { en: 'The girls started to giggle at the back of the class.', ru: 'Девочки начали хихикать на задних партах.' },
      { en: 'He gave a nervous giggle.', ru: 'Он нервно хихикнул.' },
      { en: 'Stop giggling and be serious!', ru: 'Перестаньте хихикать и будьте серьезны!' },
      { en: 'Whatever I said made her giggle.', ru: 'Что бы я ни сказал, это заставляло ее хихикать.' }
    ],
    []
  ),
  createRichWord('b2_dental', 'Dental', '/ˈden.təl/', 'дэнтл', 'Зубной / Стоматологический', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Относящийся к зубам или работе стоматолога.',
    '- Врач: "Dental appointment" (Прием у стоматолога)\n- Уход: "Dental floss" (Зубная нить)\n- Гигиена: "Dental care" (Уход за зубами)',
    [
      { en: 'I need to make a dental appointment soon.', ru: 'Мне нужно скоро записаться к стоматологу.' },
      { en: 'Good dental hygiene prevents cavities.', ru: 'Хорошая гигиена зубов предотвращает кариес.' },
      { en: 'Dental treatment can be expensive.', ru: 'Стоматологическое лечение может быть дорогим.' },
      { en: 'He studies at the dental school.', ru: 'Он учится в стоматологическом институте.' }
    ],
    []
  ),

  createRichWord('b2_digit', 'Digit', '/ˈdɪdʒ.ɪt/', 'диджит', 'Цифра / Палец', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Любая из цифр от 0 до 9; также палец на руке или ноге (анатомическое).',
    '- Число: "Single digit" (Однозначное число)\n- Код: "Enter the digits" (Введите цифры)\n- Технологии: "Digital" (Цифровой - от digit)',
    [
      { en: 'Enter the four digits of your PIN code.', ru: 'Введите четыре цифры вашего ПИН-кода.' },
      { en: 'Inflation has reached double digits.', ru: 'Инфляция достигла двузначных чисел.' },
      { en: 'The code consists of six digits.', ru: 'Код состоит из шести цифр.' },
      { en: 'The screen displays large red digits.', ru: 'На экране отображаются крупные красные цифры.' }
    ],
    []
  ),

  createRichWord('b2_disconnect', 'Disconnect', '/ˌdɪs.kəˈnekt/', 'дискэнект', 'Отключать / Разъединять', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Прервать соединение (электрическое, телефонное) или связь.',
    '- Техника: "Disconnect the power" (Отключить питание)\n- Связь: "Call was disconnected" (Звонок прервался)\n- Эмоции: "Feel disconnected" (Чувствовать отчужденность)',
    [
      { en: 'Please disconnect the TV before cleaning it.', ru: 'Пожалуйста, отключите телевизор перед чисткой.' },
      { en: 'The phone line was disconnected due to non-payment.', ru: 'Телефонную линию отключили из-за неуплаты.' },
      { en: 'I feel disconnected from the modern world.', ru: 'Я чувствую себя оторванным от современного мира.' },
      { en: 'Never disconnect the cable while the device is running.', ru: 'Никогда не отсоединяйте кабель, пока устройство работает.' }
    ],
    []
  ),

  createRichWord('b2_dishonest', 'Dishonest', '/dɪˈsɒn.ɪst/', 'дисонист', 'Нечестный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Склонный обманывать, лгать или красть; неискренний.',
    '- Человек: "Dishonest trader" (Нечестный торговец)\n- Поступок: "Dishonest behavior" (Нечестное поведение)\n- Деньги: "Dishonest means" (Нечестные средства)',
    [
      { en: 'It was dishonest of him to lie about his age.', ru: 'С его стороны было нечестно лгать о своем возрасте.' },
      { en: 'Beware of dishonest salespeople.', ru: 'Остерегайтесь нечестных продавцов.' },
      { en: 'He made money through dishonest means.', ru: 'Он заработал деньги нечестным путем.' },
      { en: 'I hate dishonest people who steal ideas.', ru: 'Я ненавижу нечестных людей, которые крадут идеи.' }
    ],
    []
  ),

  createRichWord('b2_dormitory', 'Dormitory', '/ˈdɔː.mɪ.tər.i/', 'домитри', 'Общежитие / Спальная комната', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Здание для проживания студентов (US: dorm) или большая комната с множеством кроватей (UK).',
    '- Университет: "University dormitory" (Университетское общежитие)\n- Школа: "School dormitory" (Спальня в школе-интернате)\n- Сленг: "Live in a dorm" (Жить в общаге)',
    [
      { en: 'He lives in a dormitory on campus.', ru: 'Он живет в общежитии на кампусе.' },
      { en: 'The dormitory has shared bathrooms.', ru: 'В общежитии общие ванные комнаты.' },
      { en: 'We slept in a large dormitory with twenty beds.', ru: 'Мы спали в большой общей спальне на двадцать кроватей.' },
      { en: 'Life in a dormitory can be noisy.', ru: 'Жизнь в общежитии может быть шумной.' }
    ],
    []
  ),

  createRichWord('b2_dove', 'Dove', '/dʌv/', 'дав', 'Голубь (белый) / Сторонник мира', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Птица семейства голубиных, часто белая (символ мира); в политике — сторонник мирных решений.',
    '- Символ: "White dove" (Белый голубь)\n- Политика: "Hawks and doves" (Ястребы и голуби / сторонники войны и мира)\n- Природа: "Turtle dove" (Горлица)',
    [
      { en: 'The dove is a universal symbol of peace.', ru: 'Голубь — универсальный символ мира.' },
      { en: 'A white dove was released at the wedding.', ru: 'На свадьбе выпустили белого голубя.' },
      { en: 'In the debate, he acted as a dove.', ru: 'В дебатах он выступал как сторонник мира.' },
      { en: 'We heard the soft cooing of a dove.', ru: 'Мы слышали мягкое воркование голубя.' }
    ],
    []
  ),

  createRichWord('b2_eldest', 'Eldest', '/ˈel.dɪst/', 'элдист', 'Самый старший', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Самый старший по возрасту (обычно о детях в семье).',
    '- Семья: "Eldest son" (Старший сын)\n- Родственники: "Eldest child" (Самый старший ребенок)\n- Группа: "Eldest of three" (Старший из трех)',
    [
      { en: 'She is the eldest of four children.', ru: 'Она самая старшая из четырех детей.' },
      { en: 'My eldest brother lives in Canada.', ru: 'Мой старший брат живет в Канаде.' },
      { en: 'Who is the eldest student in the class?', ru: 'Кто самый старший ученик в классе?' },
      { en: 'The eldest daughter usually helps her mother.', ru: 'Старшая дочь обычно помогает матери.' }
    ],
    []
  ),
  createRichWord('b2_encode', 'Encode', '/ɪnˈkəʊd/', 'инкоуд', 'Кодировать / Шифровать', ProficiencyLevel.B2, 'verb', 'Medium', 'Formal',
    'Преобразовывать информацию в код или формат, который может быть прочитан машиной или скрыт.',
    '- IT: "Encode data" (Кодировать данные)\n- Сообщение: "Encode a message" (Зашифровать сообщение)\n- Память: "Encode memories" (Кодировать воспоминания - психол.)',
    [
      { en: 'The software encodes the video files.', ru: 'Программа кодирует видеофайлы.' },
      { en: 'Secret messages were encoded to prevent reading.', ru: 'Секретные сообщения были зашифрованы, чтобы их нельзя было прочитать.' },
      { en: 'Information is encoded in our DNA.', ru: 'Информация закодирована в нашей ДНК.' },
      { en: 'You need a key to decode the encoded text.', ru: 'Вам нужен ключ, чтобы расшифровать закодированный текст.' }
    ],
    []
  ),

  createRichWord('b2_eternity', 'Eternity', '/ɪˈtɜː.nə.ti/', 'итёрнэти', 'Вечность', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Бесконечное время; или период, который кажется очень долгим.',
    '- Время: "For all eternity" (Навечно)\n- Ожидание: "Wait an eternity" (Ждать целую вечность)\n- Кольцо: "Eternity ring" (Кольцо вечности)',
    [
      { en: 'It felt like an eternity before he arrived.', ru: 'Казалось, прошла целая вечность, прежде чем он приехал.' },
      { en: 'They promised to love each other for eternity.', ru: 'Они обещали любить друг друга вечно.' },
      { en: 'An hour in the dentist\'s chair feels like an eternity.', ru: 'Час в кресле стоматолога кажется вечностью.' },
      { en: 'She stared out of the window for an eternity.', ru: 'Она смотрела в окно целую вечность.' }
    ],
    []
  ),

  createRichWord('b2_fanatic', 'Fanatic', '/fəˈnæt.ɪk/', 'фэнэтик', 'Фанат / Фанатик', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Человек с чрезмерным энтузиазмом по поводу чего-либо (спорт, религия, политика).',
    '- Спорт: "Football fanatic" (Футбольный фанат)\n- ЗОЖ: "Fitness fanatic" (Фитнес-фанатик)\n- Религия: "Religious fanatic" (Религиозный фанатик)',
    [
      { en: 'He is a fitness fanatic who trains every day.', ru: 'Он фитнес-фанатик, который тренируется каждый день.' },
      { en: 'Religious fanatics can be dangerous.', ru: 'Религиозные фанатики могут быть опасны.' },
      { en: 'She is a fanatic about recycling.', ru: 'Она фанатично относится к переработке мусора.' },
      { en: 'My brother is a computer game fanatic.', ru: 'Мой брат — фанат компьютерных игр.' }
    ],
    []
  ),

  createRichWord('b2_feminism', 'Feminism', '/ˈfem.ɪ.nɪ.zəm/', 'феминизэм', 'Феминизм', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Движение за права женщин и равенство полов.',
    '- Движение: "Modern feminism" (Современный феминизм)\n- История: "Wave of feminism" (Волна феминизма)\n- Убеждения: "Believe in feminism" (Верить в феминизм)',
    [
      { en: 'Feminism fights for equal rights for women.', ru: 'Феминизм борется за равные права для женщин.' },
      { en: 'She writes books about the history of feminism.', ru: 'Она пишет книги об истории феминизма.' },
      { en: 'Feminism has changed society significantly.', ru: 'Феминизм значительно изменил общество.' },
      { en: 'He supports feminism and gender equality.', ru: 'Он поддерживает феминизм и гендерное равенство.' }
    ],
    []
  ),

  createRichWord('b2_fin', 'Fin', '/fɪn/', 'фин', 'Плавник', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Тонкая плоская часть тела рыбы, используемая для плавания.',
    '- Рыба: "Shark fin" (Плавник акулы)\n- Дайвинг: "Swim with fins" (Плавать в ластах)\n- Техника: "Tail fin" (Хвостовой киль самолета)',
    [
      { en: 'We saw a shark fin in the water.', ru: 'Мы увидели плавник акулы в воде.' },
      { en: 'Fish use their fins to steer.', ru: 'Рыбы используют плавники, чтобы управлять движением.' },
      { en: 'Divers wear fins to swim faster.', ru: 'Дайверы носят ласты, чтобы плавать быстрее.' },
      { en: 'The dolphin has a dorsal fin on its back.', ru: 'У дельфина есть спинной плавник.' }
    ],
    []
  ),

  createRichWord('b2_flirt', 'Flirt', '/flɜːt/', 'флёрт', 'Флиртовать', ProficiencyLevel.B2, 'verb', 'High', 'Neutral',
    'Вести себя так, чтобы показать сексуальный интерес к кому-то, но не серьезно.',
    '- Отношения: "Flirt with someone" (Флиртовать с кем-то)\n- Идея: "Flirt with danger" (Играть с огнем / рисковать)\n- Человек: "A terrible flirt" (Ужасный кокетка/бабник)',
    [
      { en: 'He likes to flirt with all the colleagues.', ru: 'Ему нравится флиртовать со всеми коллегами.' },
      { en: 'She was flirting with the waiter.', ru: 'Она флиртовала с официантом.' },
      { en: 'Don\'t flirt with disaster by driving too fast.', ru: 'Не играй с огнем, превышая скорость.' },
      { en: 'It was just harmless flirting.', ru: 'Это был просто безобидный флирт.' }
    ],
    []
  ),

  createRichWord('b2_floral', 'Floral', '/ˈflɔː.rəl/', 'флорэл', 'Цветочный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Украшенный цветами или сделанный из цветов.',
    '- Узор: "Floral pattern" (Цветочный узор)\n- Одежда: "Floral dress" (Цветочное платье)\n- Дизайн: "Floral arrangement" (Цветочная композиция)',
    [
      { en: 'She wore a pretty floral dress.', ru: 'На ней было красивое цветочное платье.' },
      { en: 'The curtains have a floral design.', ru: 'У штор цветочный дизайн.' },
      { en: 'We ordered a floral tribute for the funeral.', ru: 'Мы заказали цветочный венок на похороны.' },
      { en: 'I prefer floral scents in perfume.', ru: 'Я предпочитаю цветочные ароматы в духах.' }
    ],
    []
  ),

  createRichWord('b2_flute', 'Flute', '/fluːt/', 'флут', 'Флейта', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Музыкальный духовой инструмент в форме трубки.',
    '- Музыка: "Play the flute" (Играть на флейте)\n- Посуда: "Champagne flute" (Бокал для шампанского - узкий)\n- Звук: "High notes of a flute" (Высокие ноты флейты)',
    [
      { en: 'She plays the flute in the school orchestra.', ru: 'Она играет на флейте в школьном оркестре.' },
      { en: 'The sound of the flute is very sweet.', ru: 'Звук флейты очень нежный.' },
      { en: 'He poured the drink into a champagne flute.', ru: 'Он налил напиток в бокал для шампанского.' },
      { en: 'I am learning to play the flute.', ru: 'Я учусь играть на флейте.' }
    ],
    []
  ),
  createRichWord('b2_dribble', 'Dribble', '/ˈdrɪb.əl/', 'дрибл', 'Вести мяч / Капать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Вести мяч короткими ударами (в спорте); или (о жидкости) течь тонкой струйкой или каплями.',
    '- Спорт: "Dribble the ball" (Вести мяч)\n- Жидкость: "Dribble down the chin" (Стекать по подбородку)\n- Ребенок: "Baby dribbles" (У ребенка текут слюнки)',
    [
      { en: 'He dribbled the ball past three defenders.', ru: 'Он обвел (провел мяч мимо) трех защитников.' },
      { en: 'Water dribbled out of the tap.', ru: 'Вода капала из крана.' },
      { en: 'The baby dribbled on his bib.', ru: 'У малыша натекли слюнки на слюнявчик.' },
      { en: 'Basketball players must learn to dribble with both hands.', ru: 'Баскетболисты должны научиться вести мяч обеими руками.' }
    ],
    []
  ),

  createRichWord('b2_drizzle', 'Drizzle', '/ˈdrɪz.əl/', 'дризл', 'Моросящий дождь', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Очень мелкий, легкий дождь.',
    '- Погода: "Light drizzle" (Легкая морось)\n- Прогноз: "Periods of drizzle" (Временами моросящий дождь)\n- Кулинария: "Drizzle of oil" (Сбрызгивание маслом)',
    [
      { en: 'It was only a light drizzle, so we didn\'t need umbrellas.', ru: 'Был лишь легкий моросящий дождь, так что зонты нам не понадобились.' },
      { en: 'The drizzle lasted all afternoon.', ru: 'Морось продолжалась весь день.' },
      { en: 'Drizzle some olive oil over the salad.', ru: 'Сбрызните салат оливковым маслом.' },
      { en: 'A cold drizzle made the streets slippery.', ru: 'Холодная морось сделала улицы скользкими.' }
    ],
    []
  ),

  createRichWord('b2_drone', 'Drone', '/drəʊn/', 'дроун', 'Дрон / Гудение', ProficiencyLevel.B2, 'noun', 'High', 'Neutral',
    'Беспилотный летательный аппарат; низкий монотонный звук.',
    '- Техника: "Fly a drone" (Запускать дрон)\n- Звук: "Drone of an engine" (Гул двигателя)\n- Природа: "Male bee" (Трутень)',
    [
      { en: 'He used a drone to take aerial photos.', ru: 'Он использовал дрон для аэросъемки.' },
      { en: 'We could hear the drone of a plane in the distance.', ru: 'Мы слышали гул самолета вдалеке.' },
      { en: 'Drones are becoming popular for delivery.', ru: 'Дроны становятся популярными для доставки.' },
      { en: 'The teacher\'s voice was a boring drone.', ru: 'Голос учителя был скучным бубнежом.' }
    ],
    [
      { meaning: "To speak monotonously (verb)", translation: "Бубнить", example: { en: "He droned on for hours.", ru: "Он бубнил часами." } }
    ]
  ),

  createRichWord('b2_duchess', 'Duchess', '/ˈdʌtʃ.es/', 'дачес', 'Герцогиня', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Женщина, имеющая тот же ранг, что и герцог, или жена герцога.',
    '- Титул: "The Duchess of York" (Герцогиня Йоркская)\n- Сказки: "Royal Duchess" (Королевская герцогиня)\n- Обращение: "Her Grace" (Ее Светлость)',
    [
      { en: 'The Duchess visited the local hospital.', ru: 'Герцогиня посетила местную больницу.' },
      { en: 'She is the Duchess of Cambridge.', ru: 'Она — герцогиня Кембриджская.' },
      { en: 'The Duke and Duchess arrived together.', ru: 'Герцог и герцогиня прибыли вместе.' },
      { en: 'In the story, the Duchess lived in a castle.', ru: 'В рассказе герцогиня жила в замке.' }
    ],
    []
  ),

  createRichWord('b2_duo', 'Duo', '/ˈdjuː.əʊ/', 'дьюоу', 'Дуэт', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Два человека, которые делают что-то вместе, особенно играют музыку или выступают.',
    '- Музыка: "Pop duo" (Поп-дуэт)\n- Люди: "Dynamic duo" (Динамичный дуэт)\n- Выступление: "Comedy duo" (Комедийный дуэт)',
    [
      { en: 'The famous duo sang their greatest hits.', ru: 'Знаменитый дуэт спел свои лучшие хиты.' },
      { en: 'They act as a dynamic duo in business.', ru: 'В бизнесе они действуют как динамичный дуэт.' },
      { en: 'Batman and Robin are a well-known duo.', ru: 'Бэтмен и Робин — известный дуэт.' },
      { en: 'The violin and piano duo performed beautifully.', ru: 'Дуэт скрипки и фортепиано выступил прекрасно.' }
    ],
    []
  ),

  createRichWord('b2_eject', 'Eject', '/iˈdʒekt/', 'иджет', 'Катапультироваться / Выбрасывать', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Выбрасывать что-то с силой; заставлять кого-то покинуть место; катапультироваться (о пилоте).',
    '- Техника: "Eject a disk" (Извлечь диск)\n- Авиация: "Pilot ejected" (Пилот катапультировался)\n- Спорт: "Player ejected" (Игрок удален)',
    [
      { en: 'The pilot managed to eject before the crash.', ru: 'Пилоту удалось катапультироваться перед крушением.' },
      { en: 'Press the button to eject the CD.', ru: 'Нажмите кнопку, чтобы извлечь CD.' },
      { en: 'He was ejected from the club for fighting.', ru: 'Его выгнали из клуба за драку.' },
      { en: 'The volcano ejected lava and ash.', ru: 'Вулкан выбросил лаву и пепел.' }
    ],
    []
  ),

  createRichWord('b2_emerald', 'Emerald', '/ˈem.ər.əld/', 'эмэрэлд', 'Изумруд / Изумрудный', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Ярко-зеленый драгоценный камень; ярко-зеленый цвет.',
    '- Камень: "Emerald ring" (Изумрудное кольцо)\n- Цвет: "Emerald green" (Изумрудно-зеленый)\n- Место: "Emerald Isle" (Изумрудный остров - Ирландия)',
    [
      { en: 'She wore a necklace with a large emerald.', ru: 'На ней было ожерелье с большим изумрудом.' },
      { en: 'The sea was a beautiful emerald green.', ru: 'Море было красивого изумрудно-зеленого цвета.' },
      { en: 'Emeralds are as precious as diamonds.', ru: 'Изумруды так же ценны, как и бриллианты.' },
      { en: 'Ireland is often called the Emerald Isle.', ru: 'Ирландию часто называют Изумрудным островом.' }
    ],
    []
  ),

  createRichWord('b2_entrant', 'Entrant', '/ˈen.trənt/', 'энтрэнт', 'Участник / Поступающий', ProficiencyLevel.B2, 'noun', 'Low', 'Formal',
    'Человек, который участвует в соревновании, или новичок в профессии/учебном заведении.',
    '- Соревнование: "Competition entrant" (Участник соревнования)\n- Работа: "New entrant" (Новый сотрудник/участник рынка)\n- Университет: "University entrant" (Абитуриент/Поступивший)',
    [
      { en: 'There were over 500 entrants in the marathon.', ru: 'В марафоне было более 500 участников.' },
      { en: 'The company is a new entrant to the market.', ru: 'Компания является новым участником рынка.' },
      { en: 'The winning entrant will receive a prize.', ru: 'Победивший участник получит приз.' },
      { en: 'Entrants must be over 18 years old.', ru: 'Участникам должно быть больше 18 лет.' }
    ],
    []
  ),

  createRichWord('b2_equator', 'Equator', '/ɪˈkweɪ.tər/', 'иквейтэ', 'Экватор', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Воображаемая линия вокруг середины Земли, делящая её на северное и южное полушария.',
    '- География: "On the equator" (На экваторе)\n- Климат: "Near the equator" (Вблизи экватора)\n- Линия: "Cross the equator" (Пересечь экватор)',
    [
      { en: 'It is very hot near the equator.', ru: 'Вблизи экватора очень жарко.' },
      { en: 'Indonesia is located on the equator.', ru: 'Индонезия расположена на экваторе.' },
      { en: 'The sun is directly overhead at the equator.', ru: 'Солнце находится прямо над головой на экваторе.' },
      { en: 'Days and nights are equal length at the equator.', ru: 'Дни и ночи равны по длине на экваторе.' }
    ],
    []
  ),

  createRichWord('b2_ethic', 'Ethic', '/ˈeθ.ɪk/', 'эсик', 'Этика / Моральный принцип', ProficiencyLevel.B2, 'noun', 'Medium', 'Formal',
    'Идея или моральное убеждение, влияющее на поведение (часто "work ethic").',
    '- Работа: "Strong work ethic" (Сильная трудовая этика)\n- Принцип: "Code of ethics" (Кодекс этики)\n- Медицина: "Medical ethics" (Медицинская этика)',
    [
      { en: 'He has a very strong work ethic.', ru: 'У него очень сильная трудовая этика (трудолюбие).' },
      { en: 'The Puritan ethic values hard work.', ru: 'Пуританская этика ценит тяжелый труд.' },
      { en: 'It is a question of professional ethics.', ru: 'Это вопрос профессиональной этики.' },
      { en: 'Cheating violates the school ethic.', ru: 'Списывание нарушает школьную этику.' }
    ],
    []
  ),
  createRichWord('b2_font', 'Font', '/fɒnt/', 'фонт', 'Шрифт', ProficiencyLevel.B2, 'noun', 'High', 'Neutral',
    'Набор букв и символов определенного стиля и размера, используемый в печати или на компьютере.',
    '- Компьютер: "Change the font" (Изменить шрифт)\n- Дизайн: "Bold font" (Жирный шрифт)\n- Чтение: "Small font" (Мелкий шрифт)',
    [
      { en: 'Please use a readable font for your essay.', ru: 'Пожалуйста, используйте читабельный шрифт для вашего эссе.' },
      { en: 'I changed the font size to make it clearer.', ru: 'Я изменил размер шрифта, чтобы сделать его более четким.' },
      { en: 'Times New Roman is a standard font.', ru: 'Times New Roman — это стандартный шрифт.' },
      { en: 'The designer chose a modern font for the logo.', ru: 'Дизайнер выбрал современный шрифт для логотипа.' }
    ],
    [
      { meaning: "Baptismal bowl (Religious)", translation: "Купель", example: { en: "The baptismal font in the church.", ru: "Крестильная купель в церкви." } },
      { meaning: "Source/Origin (Literary)", translation: "Источник / Кладезь", example: { en: "A font of wisdom.", ru: "Кладезь мудрости." } }
    ]
  ),

  createRichWord('b2_footage', 'Footage', '/ˈfʊt.ɪdʒ/', 'футидж', 'Видеоматериал / Кадры', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Отснятый видеоматериал определенного события (обычно для новостей или кино).',
    '- Новости: "News footage" (Кадры новостей)\n- Безопасность: "CCTV footage" (Запись с камер наблюдения)\n- Архив: "Rare footage" (Редкие кадры)',
    [
      { en: 'The police reviewed the CCTV footage.', ru: 'Полиция просмотрела записи с камер видеонаблюдения.' },
      { en: 'We have exclusive footage of the incident.', ru: 'У нас есть эксклюзивные кадры инцидента.' },
      { en: 'The documentary contains rare historical footage.', ru: 'Документальный фильм содержит редкие исторические кадры.' },
      { en: 'They lost hours of footage due to a technical error.', ru: 'Они потеряли часы видеоматериала из-за технической ошибки.' }
    ],
    []
  ),

  createRichWord('b2_gadget', 'Gadget', '/ˈɡædʒ.ɪt/', 'гаджет', 'Гаджет / Приспособление', ProficiencyLevel.B2, 'noun', 'High', 'Neutral',
    'Маленькое механическое или электронное устройство, придуманное для конкретной цели.',
    '- Кухня: "Kitchen gadget" (Кухонное приспособление)\n- Техника: "Latest gadget" (Новейший гаджет)\n- Польза: "Handy gadget" (Удобное приспособление)',
    [
      { en: 'He loves buying the latest electronic gadgets.', ru: 'Он обожает покупать новейшие электронные гаджеты.' },
      { en: 'This handy gadget opens jars easily.', ru: 'Это удобное приспособление легко открывает банки.' },
      { en: 'The kitchen is full of useless gadgets.', ru: 'Кухня полна бесполезных приспособлений.' },
      { en: 'Smartphones are the most popular gadgets today.', ru: 'Смартфоны — самые популярные гаджеты сегодня.' }
    ],
    []
  ),

  createRichWord('b2_gangster', 'Gangster', '/ˈɡæŋ.stər/', 'гэнгстэ', 'Гангстер / Бандит', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Член организованной группы преступников.',
    '- Криминал: "Chicago gangsters" (Чикагские гангстеры)\n- Кино: "Gangster movie" (Гангстерский фильм)\n- Личность: "Notorious gangster" (Печально известный бандит)',
    [
      { en: 'Al Capone was a famous American gangster.', ru: 'Аль Капоне был известным американским гангстером.' },
      { en: 'The movie is about rival gangster families.', ru: 'Фильм рассказывает о враждующих гангстерских семьях.' },
      { en: 'He acted like a gangster to scare people.', ru: 'Он вел себя как бандит, чтобы пугать людей.' },
      { en: 'Police arrested the gangster after a long chase.', ru: 'Полиция арестовала гангстера после долгой погони.' }
    ],
    []
  ),

  createRichWord('b2_germ', 'Germ', '/dʒɜːm/', 'джём', 'Микроб / Бактерия', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Очень маленький организм, вызывающий болезни.',
    '- Гигиена: "Kill germs" (Убивать микробы)\n- Болезнь: "Spread germs" (Распространять микробы)\n- Руки: "Wash away germs" (Смыть микробы)',
    [
      { en: 'Wash your hands to get rid of germs.', ru: 'Мой руки, чтобы избавиться от микробов.' },
      { en: 'Germs can spread quickly in a classroom.', ru: 'Микробы могут быстро распространяться в классе.' },
      { en: 'This cleaner kills 99% of household germs.', ru: 'Это чистящее средство убивает 99% бытовых микробов.' },
      { en: 'Cover your mouth to stop germs spreading.', ru: 'Прикрывай рот, чтобы остановить распространение микробов.' }
    ],
    [
      { meaning: "Early stage/Origin (Abstract)", translation: "Зародыш / Начало", example: { en: "The germ of an idea.", ru: "Зародыш идеи." } },
      { meaning: "Part of a seed (Botany)", translation: "Зародыш (зерна)", example: { en: "Wheat germ.", ru: "Зародыш пшеницы." } }
    ]
  ),
  createRichWord('b2_disobedient', 'Disobedient', '/ˌdɪs.əˈbiː.di.ənt/', 'дисобидиэнт', 'Непослушный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Отказывающийся делать то, что велят; нарушающий правила.',
    '- Дети: "Disobedient child" (Непослушный ребенок)\n- Поведение: "Disobedient act" (Акт неповиновения)\n- Школа: "Punish disobedient students" (Наказывать непослушных студентов)',
    [
      { en: 'The disobedient dog ran away from its owner.', ru: 'Непослушная собака убежала от хозяина.' },
      { en: 'He was punished for being disobedient at school.', ru: 'Его наказали за непослушание в школе.' },
      { en: 'She is rarely disobedient to her parents.', ru: 'Она редко не слушается своих родителей.' },
      { en: 'Disobedient soldiers face severe penalties.', ru: 'Непокорным солдатам грозят суровые наказания.' }
    ],
    []
  ),

  createRichWord('b2_disrespect', 'Disrespect', '/ˌdɪs.rɪˈspekt/', 'дисриспект', 'Неуважение', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Отсутствие уважения или вежливости по отношению к кому-либо.',
    '- Поведение: "Show disrespect" (Проявлять неуважение)\n- Отношение: "Total disrespect" (Полное неуважение)\n- Фраза: "No disrespect intended" (Без обид / Не хотел обидеть)',
    [
      { en: 'I meant no disrespect by my comment.', ru: 'Я не хотел проявить неуважение своим комментарием.' },
      { en: 'Shouting at the teacher is a sign of disrespect.', ru: 'Крик на учителя — это признак неуважения.' },
      { en: 'He treats his colleagues with total disrespect.', ru: 'Он относится к своим коллегам с полным неуважением.' },
      { en: 'Disrespect for the law leads to chaos.', ru: 'Неуважение к закону ведет к хаосу.' }
    ],
    []
  ),

  createRichWord('b2_domino', 'Domino', '/ˈdɒm.ɪ.nəʊ/', 'доминоу', 'Домино', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Небольшая прямоугольная плитка с точками, используемая в играх; сама игра.',
    '- Игра: "Play dominoes" (Играть в домино)\n- Эффект: "Domino effect" (Эффект домино)\n- Предмет: "Knock over a domino" (Опрокинуть костяшку домино)',
    [
      { en: 'My grandfather taught me how to play dominoes.', ru: 'Мой дедушка научил меня играть в домино.' },
      { en: 'The collapse of the bank caused a domino effect.', ru: 'Крах банка вызвал эффект домино.' },
      { en: 'We lined up the dominoes and knocked them down.', ru: 'Мы выстроили домино в ряд и опрокинули их.' },
      { en: 'One small event started a domino chain reaction.', ru: 'Одно маленькое событие запустило цепную реакцию домино.' }
    ],
    []
  ),

  createRichWord('b2_dude', 'Dude', '/duːd/', 'дуд', 'Чувак / Парень', ProficiencyLevel.B2, 'noun', 'High', 'Slang',
    'Сленговое слово для обозначения мужчины или парня (часто используется как обращение).',
    '- Обращение: "Hey dude!" (Эй, чувак!)\n- Описание: "Cool dude" (Клевый парень)\n- Реакция: "Dude, seriously?" (Чувак, серьезно?)',
    [
      { en: 'Hey dude, what are you doing tonight?', ru: 'Эй, чувак, что делаешь сегодня вечером?' },
      { en: 'He is a really chill dude.', ru: 'Он реально спокойный парень.' },
      { en: 'Dude, you won\'t believe what happened!', ru: 'Чувак, ты не поверишь, что случилось!' },
      { en: 'Don\'t call your boss "dude".', ru: 'Не называй своего начальника "чувак".' }
    ],
    []
  ),

  createRichWord('b2_duet', 'Duet', '/djuˈet/', 'дъюэт', 'Дуэт', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Музыкальное произведение для двух исполнителей.',
    '- Музыка: "Sing a duet" (Петь дуэтом)\n- Исполнение: "Piano duet" (Фортепианный дуэт)\n- Партнерство: "Perform a duet" (Исполнять дуэт)',
    [
      { en: 'They sang a romantic duet together.', ru: 'Они спели романтический дуэт вместе.' },
      { en: 'The concert featured a piano duet.', ru: 'В концерте был представлен фортепианный дуэт.' },
      { en: 'She performed a duet with a famous star.', ru: 'Она исполнила дуэт с известной звездой.' },
      { en: 'The song was originally written as a duet.', ru: 'Песня была изначально написана как дуэт.' }
    ],
    []
  ),
  createRichWord('b2_fiancee', 'Fiancee', '/fiˈɒn.seɪ/', 'фионсей', 'Невеста', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Женщина, которая помолвлена и собирается выйти замуж (мужчина - fiancé).',
    '- Отношения: "Introduce fiancee" (Представить невесту)\n- Свадьба: "Future fiancee" (Будущая невеста)\n- Статус: "Engaged to fiancee" (Помолвлен с невестой)',
    [
      { en: 'He introduced his fiancee to his parents.', ru: 'Он представил свою невесту родителям.' },
      { en: 'His fiancee works as a doctor.', ru: 'Его невеста работает врачом.' },
      { en: 'They bought a ring for his fiancee.', ru: 'Они купили кольцо для его невесты.' },
      { en: 'He is traveling with his fiancee.', ru: 'Он путешествует со своей невестой.' }
    ],
    []
  ),

  createRichWord('b2_freckle', 'Freckle', '/ˈfrek.əl/', 'фрекл', 'Веснушка', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Маленькое коричневое пятнышко на коже, появляющееся от солнца.',
    '- Лицо: "Covered in freckles" (Покрытый веснушками)\n- Солнце: "Get freckles" (Покрыться веснушками)\n- Внешность: "Cute freckles" (Милые веснушки)',
    [
      { en: 'She has freckles on her nose.', ru: 'У нее веснушки на носу.' },
      { en: 'The sun makes my freckles darker.', ru: 'От солнца мои веснушки темнеют.' },
      { en: 'He is a redhead with lots of freckles.', ru: 'Он рыжий с множеством веснушек.' },
      { en: 'Freckles often run in families.', ru: 'Веснушки часто передаются по наследству.' }
    ],
    []
  ),

  createRichWord('b2_freshman', 'Freshman', '/ˈfreʃ.mən/', 'фрешмэн', 'Первокурсник', ProficiencyLevel.B2, 'noun', 'Low', 'Neutral',
    'Студент первого курса университета или колледжа (особенно в США).',
    '- Университет: "College freshman" (Первокурсник колледжа)\n- Год: "Freshman year" (Первый курс)\n- Новичок: "Incoming freshman" (Вновь поступивший)',
    [
      { en: 'It is his freshman year at Harvard.', ru: 'Это его первый курс в Гарварде.' },
      { en: 'The freshman students looked lost.', ru: 'Студенты-первокурсники выглядели потерянными.' },
      { en: 'She lives in the freshman dormitory.', ru: 'Она живет в общежитии для первокурсников.' },
      { en: 'As a freshman, he has a lot to learn.', ru: 'Как первокурснику, ему предстоит многому научиться.' }
    ],
    []
  ),
  createRichWord('b2_disorganized', 'Disorganized', '/dɪsˈɔː.ɡə.naɪzd/', 'дисорганайзд', 'Неорганизованный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Плохо спланированный; не умеющий планировать свое время или работу.',
    '- Характер: "Disorganized person" (Неорганизованный человек)\n- Работа: "Disorganized approach" (Бессистемный подход)\n- Вид: "Disorganized desk" (Заваленный стол)',
    [
      { en: 'The meeting was chaotic and completely disorganized.', ru: 'Встреча была хаотичной и совершенно неорганизованной.' },
      { en: 'He is too disorganized to run a business.', ru: 'Он слишком неорганизован, чтобы управлять бизнесом.' },
      { en: 'Her notes were disorganized and hard to read.', ru: 'Ее заметки были беспорядочными, и их было трудно читать.' },
      { en: 'A disorganized kitchen makes cooking difficult.', ru: 'В неорганизованной кухне трудно готовить.' }
    ],
    []
  ),

  createRichWord('b2_dynamite', 'Dynamite', '/ˈdaɪ.nə.maɪt/', 'дайнэмайт', 'Динамит', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Мощное взрывчатое вещество; что-то очень захватывающее или опасное (перен.).',
    '- Взрывчатка: "Stick of dynamite" (Шашка динамита)\n- Эффект: "Political dynamite" (Политическая бомба)\n- Идиома: "Like dynamite" (Эффект разорвавшейся бомбы)',
    [
      { en: 'Miners used dynamite to blast through the rock.', ru: 'Шахтеры использовали динамит, чтобы взорвать скалу.' },
      { en: 'The news was absolute dynamite.', ru: 'Новости произвели эффект разорвавшейся бомбы.' },
      { en: 'Handle the dynamite with extreme care.', ru: 'Обращайтесь с динамитом с крайней осторожностью.' },
      { en: 'Alfred Nobel invented dynamite.', ru: 'Альфред Нобель изобрел динамит.' }
    ],
    []
  ),

  createRichWord('b2_emigrant', 'Emigrant', '/ˈem.ɪ.ɡrənt/', 'эмигрант', 'Эмигрант', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Человек, который покидает свою страну, чтобы жить в другой (акцент на выезде).',
    '- Статус: "Emigrant visa" (Эмигрантская виза)\n- Действие: "European emigrants" (Европейские эмигранты)\n- История: "Wave of emigrants" (Волна эмигрантов)',
    [
      { en: 'My grandfather was an emigrant from Italy.', ru: 'Мой дедушка был эмигрантом из Италии.' },
      { en: 'Thousands of emigrants left the country during the war.', ru: 'Тысячи эмигрантов покинули страну во время войны.' },
      { en: 'The ship was full of emigrants seeking a new life.', ru: 'Корабль был полон эмигрантов, ищущих новую жизнь.' },
      { en: 'Emigrants often send money back home.', ru: 'Эмигранты часто отправляют деньги домой.' }
    ],
    []
  ),

  createRichWord('b2_envious', 'Envious', '/ˈen.vi.əs/', 'энвиэс', 'Завистливый', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Желающий того, что есть у другого; испытывающий зависть.',
    '- Чувство: "Envious of success" (Завидующий успеху)\n- Взгляд: "Envious glances" (Завистливые взгляды)\n- Отношение: "Slightly envious" (Слегка завидующий)',
    [
      { en: 'I am envious of your long holiday.', ru: 'Я завидую твоему длинному отпуску.' },
      { en: 'She cast an envious look at her sister\'s dress.', ru: 'Она бросила завистливый взгляд на платье сестры.' },
      { en: 'Colleagues were envious of his promotion.', ru: 'Коллеги завидовали его повышению.' },
      { en: 'Do not be envious of others\' wealth.', ru: 'Не завидуй богатству других.' }
    ],
    []
  ),
  createRichWord('b2_flashlight', 'Flashlight', '/ˈflæʃ.laɪt/', 'флэшлайт', 'Карманный фонарик', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Небольшой портативный электрический фонарь (американский вариант; британский — torch).',
    '- Поход: "Turn on the flashlight" (Включить фонарик)\n- Свет: "Beam of the flashlight" (Луч фонарика)\n- Батарейки: "Flashlight batteries" (Батарейки для фонарика)',
    [
      { en: 'We used a flashlight to find the way in the dark.', ru: 'Мы использовали фонарик, чтобы найти дорогу в темноте.' },
      { en: 'The batteries in my flashlight are dead.', ru: 'Батарейки в моем фонарике сели.' },
      { en: 'He shone the flashlight into the cave.', ru: 'Он посветил фонариком в пещеру.' },
      { en: 'Always keep a flashlight in your car for emergencies.', ru: 'Всегда держите фонарик в машине на случай чрезвычайных ситуаций.' }
    ],
    []
  ),

  createRichWord('b2_freeway', 'Freeway', '/ˈfriː.weɪ/', 'фривэй', 'Автострада / Шоссе', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Широкая дорога для быстрого движения транспорта, обычно без перекрестков (американский вариант).',
    '- Движение: "Busy freeway" (Оживленная автострада)\n- Поездка: "Get on the freeway" (Выехать на автостраду)\n- Пробки: "Freeway traffic" (Движение на шоссе)',
    [
      { en: 'We drove down the freeway at high speed.', ru: 'Мы ехали по автостраде на высокой скорости.' },
      { en: 'There was a traffic jam on the freeway this morning.', ru: 'Сегодня утром на шоссе была пробка.' },
      { en: 'Take the next exit off the freeway.', ru: 'Сверните на следующем съезде с автострады.' },
      { en: 'The hotel is located right next to the freeway.', ru: 'Отель расположен прямо рядом с шоссе.' }
    ],
    []
  ),
  createRichWord('b2_dime', 'Dime', '/daɪm/', 'дайм', 'Дайм (монета)', ProficiencyLevel.B2, 'noun', 'Medium', 'Neutral',
    'Монета в США и Канаде достоинством в 10 центов.',
    '- Деньги: "Ten dimes" (Десять даймов)\n- Идиома: "A dime a dozen" (Пруд пруди / Дешевый)\n- История: "Thin dime" (Тонкий дайм)',
    [
      { en: 'He put a dime in the parking meter.', ru: 'Он опустил дайм в парковочный счетчик.' },
      { en: 'Ideas are a dime a dozen, execution is key.', ru: 'Идей пруд пруди, главное — это исполнение.' },
      { en: 'I don\'t have a single dime on me.', ru: 'У меня с собой нет ни цента (ни дайма).' },
      { en: 'The phone call cost only a dime back then.', ru: 'Телефонный звонок тогда стоил всего дайм.' }
    ],
    []
  ),

  createRichWord('b2_disloyal', 'Disloyal', '/dɪsˈlɔɪ.əl/', 'дислойэл', 'Нелояльный / Неверный', ProficiencyLevel.B2, 'adj', 'Medium', 'Neutral',
    'Не поддерживающий своих друзей, семью, страну или группу; предательский.',
    '- Отношения: "Disloyal friend" (Неверный друг)\n- Работа: "Disloyal employee" (Нелояльный сотрудник)\n- Критика: "Not disloyal to criticise" (Критиковать — не значит быть нелояльным)',
    [
      { en: 'He was accused of being disloyal to the party.', ru: 'Его обвинили в нелояльности к партии.' },
      { en: 'It would be disloyal to leave them now.', ru: 'Было бы предательством бросить их сейчас.' },
      { en: 'She felt disloyal for talking behind his back.', ru: 'Она чувствовала себя предательницей, говоря у него за спиной.' },
      { en: 'A disloyal act can ruin a friendship.', ru: 'Неверный поступок может разрушить дружбу.' }
    ],
    []
  ),

  createRichWord('b2_disobey', 'Disobey', '/ˌdɪs.əˈbeɪ/', 'дисэбей', 'Не подчиняться', ProficiencyLevel.B2, 'verb', 'Medium', 'Neutral',
    'Отказываться делать то, что вам говорят делать (нарушать правила или приказы).',
    '- Правила: "Disobey rules" (Нарушать правила)\n- Родители: "Disobey parents" (Не слушаться родителей)\n- Закон: "Disobey the law" (Нарушать закон)',
    [
      { en: 'Soldiers who disobey orders are punished.', ru: 'Солдат, не подчиняющихся приказам, наказывают.' },
      { en: 'Don\'t disobey your mother.', ru: 'Не смей не слушаться мать.' },
      { en: 'He decided to disobey the instructions.', ru: 'Он решил не подчиняться инструкциям.' },
      { en: 'If you disobey, there will be consequences.', ru: 'Если ты ослушаешься, будут последствия.' }
    ],
    []
  ),
